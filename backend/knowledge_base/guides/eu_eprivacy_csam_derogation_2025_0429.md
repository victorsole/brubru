...
## QUICK FACTS
- **LATEST (July 2026 — COUNCIL FIRST-READING POSITION PUBLISHED IN THE OJ C-SERIES):** The **Council's first-reading position** on the derogation extension — **Position (EU) No 9/2026 of the Council** (CELEX **52026AG0009(01)**), together with the Council's **statement of reasons** (CELEX **52026AG0009(02)**) — was published in the Official Journal C-series in July 2026. This is the formal Council position document in the ordinary legislative procedure for amending Regulation (EU) 2021/1232; per OEIL the procedure is now **COMPLETED** (Parliament approved the extension at the July plenary — see the 9 July note below). The publication completes the documentary record and gives the citable OJ reference for the Council's position; it is a paper-trail publication, not a new political step.
- **LATEST (Monday 13 July 2026 — LONG-TERM CSA REGULATION BACK ON THE LIBE AGENDA):** During the 13-17 July committee week, **LIBE (meeting Monday 13 July 2026)** takes up the **long-term Child Sexual Abuse Regulation** ("Laying down rules to prevent and combat child sexual abuse") — the substantive, permanent instrument (procedure 2022/0155(COD)) that is **distinct from** the temporary ePrivacy derogation extension (2025/0429(COD)) this guide primarily covers. The derogation, adopted by plenary on 9 July 2026, is only the stop-gap that keeps *voluntary* scanning legal until 3 April 2028; the 2022/0155 file is the contested permanent framework (the "detection order" debate) that has stayed blocked in Council. Its return to the LIBE agenda signals the Irish Presidency (July-December 2026) intends to reopen it. The same LIBE meeting also covered Irish Presidency priorities, Europol's TE-SAT 2026 report, and the upcoming EU Anti-Corruption Strategy. Source: EP eMeeting LIBE agenda (LIBE(2026)0713_1). Do not conflate 2022/0155(COD) (permanent CSA Regulation) with 2025/0429(COD) (derogation extension).
- **LATEST (Thursday 9 July 2026 — DEROGATION EXTENSION ADOPTED BY PLENARY)**: The European Parliament **approved the extension of the ePrivacy CSAM derogation** at the July Strasbourg plenary (final sitting before summer recess). Handled at second reading, opponents needed an **absolute majority of Parliament's component members (361 votes)** to reject or amend the Council's position; the rejection/amendment motions **failed to reach that 361-vote threshold**, so the Council position stands and the file is **adopted** — concluding the ordinary legislative procedure pending signature and OJ publication. The extended derogation now applies **until 3 April 2028** (closing the gap left when the previous derogation lapsed on 3 April 2026). Voluntary CSAM scanning of communications by online providers therefore regains its EU legal basis; the derogation remains **voluntary** (permits, does not require, scanning of known CSAM), does not mandate breaking end-to-end encryption, and does not grant governments direct message access. Former MEP Patrick Breyer (Pirate Party) called the outcome "a farce" that "damages democracy," arguing it advanced "against the will of the majority of voting MEPs" via the urgency route. **Exact roll-call tally pending the doceo RCV record** (PV-10-2026-07-09-RCV). Sources: EP plenary 9 July 2026 + plenary press coverage (Euronews, Brussels Signal, EU Perspectives). Rapporteur **Birgit Sippel** (S&D, Germany), LIBE.
- **PRIOR (Wednesday 8 July 2026 — PLENARY RE-VOTE UNDER URGENCY; BINDING VOTE THURSDAY 9 JULY)**: During the July Strasbourg plenary (final before summer recess) the derogation extension returned to the floor via an **urgent procedure (Rule 170)**. On **Tuesday 7 July 2026** the plenary narrowly approved holding the vote under urgency by **331 in favour, 304 against, 11 abstentions** — a deliberately tight margin that reopened the "chat control" fight. The **binding plenary vote is scheduled for Thursday 9 July 2026**: because the file is being handled as a Commission proposal to extend, opponents would need an **absolute majority of Parliament's component members (361 votes)** to reject or amend it, not just a majority of those voting. The underlying temporary derogation in **Regulation (EU) 2021/1232** already lapsed in early April 2026, so platforms have had no EU legal basis for voluntary CSAM scanning in the interim; the extension would restore it while the long-term CSAM Regulation (2022/0155(COD)) stays blocked. Source: EP plenary adopted-texts index for 7-9 July 2026 (europarl.europa.eu/doceo, TA-10-2026-07-07/08/09) + plenary press coverage of the urgency vote. Rapporteur **Birgit Sippel** (S&D, Germany), LIBE.
- **PRIOR (Thursday 21 May 2026 — LIBE DRAFT REPORT TABLED)**: The Committee on Civil Liberties, Justice and Home Affairs (LIBE) **tabled the draft report** on procedure 2025/0429(COD). Source: EP committees portal — LIBE Draft Report listing (21 May 2026, europarl.europa.eu/committees/en/libe). The procedure amends **Regulation (EU) 2021/1232** to **extend its period of application** — the regulation provides a temporary derogation from certain provisions of Directive 2002/58/EC (the ePrivacy Directive) to allow online service providers to use technologies to voluntarily detect, report, and remove **online child sexual abuse material (CSAM)** and detect grooming on their services. The **temporary derogation expired on 3 April 2026**, creating a legal-certainty gap; the proposal extends application while the long-term CSAM Regulation negotiation (separate, 2022/0155(COD)) remains unresolved. The next step is the **LIBE committee vote on 26 May 2026 (TBC)**, then plenary vote in June 2026.
