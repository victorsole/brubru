...
- **PARLIAMENT: THIS IS A THREE-COMMITTEE JOINT FILE (Rule 58). Verified against OEIL on 22 September 2026.** Do NOT call any one of them "the lead committee", and do NOT name any one of them "the rapporteur": there are **three co-rapporteurs of equal standing**, all appointed **29 April 2026**.
  ...
  - **Committee stage, read from the documents on 23 September 2026:** joint **draft report PE792.067** (9 September 2026, **267 amendments**, signed by all three co-rapporteurs; most amended Article 34, the Net-Zero Industry Act rewrite, 58). The file is **item 3 at the INTA-ITRE-IMCO joint committee on 28 September 2026**. ENVI (opinion only): **draft opinion PE789.106** (Androuët, 17 June 2026, 282 amendments; wants Union origin to require at least 60% European added value, e-powertrain share 60% instead of 50%, nuclear added to the NZIA as a dispatchable low-carbon technology) and **767 ENVI members' amendments, numbered 283 to 1049** (PE791.124 and PE791.125, 23 July 2026). Most contested: **Annex III vehicles (79)**, where EPP, S&D and ECR members push the Union-origin value share for publicly funded electric vehicles **from 70% to 80%**; **Article 25 acceleration areas (55)**; **Article 34 (51)**. **PE790.123 is NOT an ENVI document: it is the French Senate's reasoned opinion of 18 June 2026**, finding a breach of subsidiarity and proportionality (one-stop shop ignores state and local powers; binding deadlines plus tacit authorisation raise legal uncertainty). Members' amendments to the joint draft report were not yet published on 23 September.
...
- **LATEST (adopted Wednesday 15 July 2026, announced Monday 20 July 2026 — EESC OPINION):** The **European Economic and Social Committee adopted its mandatory opinion on the Industrial Accelerator Act** at its **607th plenary session on 15 July 2026** (reference **INT/1119-EESC-2026-00379-00-00-AC**; Bureau decision 20 January 2026; section: Single Market, Production and Consumption (INT)). **Rapporteur: Konstantinos Diamantouros** (Employers' Group I, Greece). Referral: **COM(2026) 100 final — 2026/0068(COD)** (this file). The EESC press release of 20 July frames it as backing "Made in Europe" **but calling for stricter safeguards and more focus on workers**. Key points from the adopted opinion:
  ...
  The EESC opinion is **consultative, not binding**, but on a mandatory referral it is a formal step in the file and a reliable read on employer/worker/civil-society positioning ahead of the joint INTA-ITRE-IMCO committee stage. Note the EESC opinion arrives while the three joint committees are still in the pre-report phase.
...
- **Legal form:** Regulation (directly applicable in all Member States)
- **Legal basis:** Article 114 TFEU (internal market) and Article 207(2) TFEU (common commercial policy), as cited in the proposal.
- **Responsible DG:** DG GROW (Internal Market, Industry, Entrepreneurship and SMEs)
- **Responsible Commissioner:** Stephane Sejourne (Executive Vice-President for Prosperity and Industrial Strategy)
- **Supporting documents:** SWD(2026)70 (Subsidiarity Grid), SWD(2026)71 (Impact Assessment), SWD(2026)72 (Executive Summary)

## Key Measures

### 1. Permitting Acceleration
- Streamlined and digitalised permitting procedures for industrial decarbonisation projects
- Addresses permitting bottlenecks not already covered by the Net-Zero Industry Act (Regulation (EU) 2024/1735, CELEX 32024R1735)
- Commission may use AI to help accelerate the permit-granting process
- Member States urged to improve administrative capacities for timely permit processing

### 2. Low-Carbon Product Labels
- Introduction of voluntary carbon intensity labels for EU-made clean products
- Initial scope: **steel**, then **cement**
- Labels based on clean, resilient, circular, and cybersecure criteria
- Aim: create transparency for buyers and incentivise low-carbon production

### 3. Public Procurement
- Minimum proportion requirements for clean products in public contracts
- Sustainability and resilience criteria for public and private procurement
- European preference in strategic sectors (aligned with Single Market Strategy revision scheduled for 2026)

### 4. Lead Markets for EU-Made Clean Products
- Create lead markets for European clean, resilient industrial technologies and products
- Support production of EU-made clean products through regulatory framework
- Linked to the future Circular Economy Act (scheduled 2026)

### 5. State Aid and Financing
- Conditions certain state aid subsidies on sustainability criteria
- Clean Industry State Aid Framework (CISAF, adopted 25 June 2025) provides the backdrop
- Carbon Contracts for Difference (CCfDs) as a key instrument for hard-to-abate sectors
- Industrial Decarbonisation Bank to mobilise EUR 100 billion
- Innovation Fund and InvestEU as financing vehicles
- IPCEI framework made more accessible to SMEs (EUR 50 million threshold for GBER)

### 6. Strategic Sectors
The Act targets sectors central to decarbonisation and strategic autonomy:
- Steel and metals
- Cement
- Chemicals
- Clean technology manufacturing (solar, wind, batteries, heat pumps, electrolysers)
- Automotive
...
- **Article 25**: Designating national industrial manufacturing acceleration areas (every Member State designates at least one within 12 months of entry into force)
...
The Industrial Accelerator Act was adopted at the **weekly College of Commissioners meeting on Wednesday 4 March 2026**. The same College meeting also adopted:

| Ref | Item |
|-----|------|
| **IP/26/515** | Industrial Accelerator Act (COM(2026)100) |
| **IP/26/484** | EU Industrial Maritime and Ports Strategies |
| **IP/26/522** | Registration of European Citizens' Initiative for a European social media platform |
| **IP/26/537** | 2025 Safety Gate Report (dangerous products) |
| **IP/26/512** | European Globalisation Adjustment Fund proposal (EUR 2 million) |

Supporting documents published the same day: FS/26/487 (Maritime Strategy factsheet), FS/26/488 (Ports Strategy factsheet), QANDA/26/485 (Maritime/Ports Q&A), QANDA/26/516 (Industrial Accelerator Act Q&A).

Daily News reference: MEX/26/528.
...
|------|-------|-----------|
| 29 Jan 2025 | Competitiveness Compass | COM(2025)30 |
| 26 Feb 2025 | Clean Industrial Deal Communication | COM(2025)85 |
| 19 Jun 2025 | EP Resolution on Clean Industrial Deal | 2025/2656(RSP), P10_TA(2025)0137 |
| 2 Jul 2025 | "Delivering on the Clean Industrial Deal I" | COM(2025)378 |
| 17 Nov 2025 | Commission response to EP Resolution | SP(2025)329 |
| 4 Mar 2026 | **Industrial Accelerator Act proposal** | **COM(2026)100** |

### Relationship to Net-Zero Industry Act
The NZIA (Regulation (EU) 2024/1735, CELEX 32024R1735) focuses on manufacturing capacity for net-zero technologies. The Industrial Accelerator Act complements it by addressing:
- Industrial decarbonisation (demand side, not just supply of clean tech)
- Permitting bottlenecks beyond NZIA scope
- Low-carbon product labelling and procurement (market creation)
- Broader strategic sector coverage (steel, cement, chemicals)

## EP Resolution: Comparative Analysis

On 19 June 2025, the European Parliament adopted resolution 2025/2656(RSP) on the Clean Industrial Deal. This resolution directly shaped the Industrial Accelerator Act.

### Resolution Details
- **Rapporteur:** Tom Berendsen (EPP / NL)
- **Committee:** ITRE (Industry, Research and Energy)
- **Shadow rapporteurs:** Nicolas Gonzalez Casares (S&D), Isabella Tovaglieri (PfE), Daniel Obajtek (ECR), Christophe Grudler (Renew), Sara Matthieu (Greens/EFA), Hanna Gedin (The Left)
- **Motions:** B10-0277/2025 and B10-0278/2025

### What the EP Asked vs What the Commission Proposed

| EP Resolution Request | Commission Response (Nov 2025) | Industrial Accelerator Act (Mar 2026) |
|----------------------|-------------------------------|--------------------------------------|
| **Industrial Decarbonisation Bank** (EUR 100bn) | Welcomed; pointed to Innovation Fund and InvestEU as vehicles | Included as financing framework |
| **Carbon Contracts for Difference** for hard-to-abate sectors | Committed to CCfD guidance; "auctions-as-a-service" via Innovation Fund | CCfDs as key instrument, CISAF framework in place |
| **Simplified permitting** and digitalised procedures | Committed to IAA measures beyond NZIA scope; AI for permit-granting | Core measure: permitting acceleration with digitalisation |
| **Lead markets** for EU-made clean, circular products with carbon intensity labels | Announced IAA would create lead markets and regulatory framework | Low-carbon labels (steel, cement), public procurement criteria |
| **Accessible IPCEI** for SMEs | Highlighted GBER EUR 50mn threshold; SME participation rising to 60% | SME accessibility maintained |
| **Sector-specific action plans** (automotive, steel, chemicals, transport) | Confirmed Strategic Dialogues ongoing; plans for all requested sectors | Strategic sectors explicitly covered |
| **Aerospace and alternative fuels** inclusion | Not explicitly addressed in November response | To be confirmed in final text |
| **FSR enforcement** against unfair foreign subsidies | Committed to vigorous enforcement; record 33 investigations in 2024 | Complementary trade defence measures |
| **CBAM extension** to downstream products | Legislative proposal for steel/aluminium downstream by Q4 2025 | Linked via CBAM anti-circumvention strategy |
| **CO2 transport and infrastructure** framework | New legislative initiative for EU CO2 market planned for 2026 | Related but separate initiative |
| **Simplified procurement** with sustainability/resilience criteria | Single Market Strategy revision (2026) to include European preference | Public procurement provisions included |
| **Skills and VET** for green transition | VET Strategy and European Alliance for Apprenticeships ongoing | Linked to Union of Skills initiative |

### Key Alignment Areas
The Industrial Accelerator Act broadly aligns with the EP resolution. The Parliament's core demands -- permitting acceleration, lead markets, low-carbon labels, CCfDs, and SME accessibility -- are all addressed. This suggests strong potential for cross-party support during the legislative procedure.

### Areas of Potential Friction
- **Scope of European preference** in public procurement (trade policy sensitivity)
- **Stringency of low-carbon criteria** (industry vs environmental ambition)
...
| Body | Role |
|------|------|
| DG GROW | Lead Commission DG |
| DG CLIMA | Climate aspects, ETS/CBAM interface |
| DG ENER | Energy aspects, hydrogen, CCfDs |
| DG TRADE | Trade defence, FSR, CBAM |
| ITRE Committee (EP) | Expected lead committee |
| ENVI Committee (EP) | Expected opinion (environmental aspects) |
| IMCO Committee (EP) | Expected opinion (internal market/procurement) |
| Competitiveness Council | Council configuration |

## Related Legislation

| Legislation | CELEX | Relationship |
|-------------|-------|-------------|
| Net-Zero Industry Act (EU) 2024/1735 | 32024R1735 | Complementary: NZIA covers manufacturing, IAA covers industrial decarbonisation + markets |
| Carbon Border Adjustment Mechanism (EU) 2023/956 | 32023R0956 | Related: IAA complements CBAM on carbon leakage prevention |
| EU ETS revision (EU) 2023/959 | 32023L0959 | Related: carbon pricing framework for IAA sectors |
| Foreign Subsidies Regulation (EU) 2022/2560 | 32022R2560 | Related: level playing field for EU industry |
| Ecodesign for Sustainable Products (EU) 2024/1781 | 32024R1781 | Related: product sustainability requirements |
| CLP Regulation (EC) 1272/2008 | 32008R1272 | Referenced: simplification mentioned in Commission response |

## Sources

- Commission press release: IP/26/515 (4 March 2026)
- Proposal text: COM(2026)100
- Impact assessment: SWD(2026)71
- EP Resolution on Clean Industrial Deal: 2025/2656(RSP), P10_TA(2025)0137
- Commission follow-up to EP Resolution: SP(2025)329 (17 November 2025)
- EP Legislative Train: Industrial Decarbonisation Accelerator Act
- Clean Industrial Deal Communication: COM(2025)85

## First Plenary Vote Prediction (Pre-Assignment)

This is an early prediction made before committee assignment and rapporteur designation. Reliability: LOW-MEDIUM.

### Predicted Committee Team

Based on the Clean Industrial Deal resolution (2025/2656(RSP)), which was the direct precursor to this legislative proposal, we predict the same ITRE team will handle the IAA:
...
| Shadow (Renew) | Christophe Grudler | Renew (FR) | Medium |
| Shadow (Greens/EFA) | Sara Matthieu | Greens/EFA (BE) | Medium |
| Shadow (The Left) | Hanna Gedin | The Left (SE) | Medium |

**Caveat:** Committee assignments for COD procedures may differ from RSP resolutions. The ITRE coordinator will decide -- a different rapporteur from the same group is possible.

### Predicted EP Group Positions

| Group | Seats | Predicted Position | Reasoning |
|-------|-------|--------------------|-----------|
| EPP | 188 | FOR | Their rapporteur led the CID resolution; industrial competitiveness is a core EPP priority |
| S&D | 136 | FOR | Supported CID resolution; aligned with workers' transition and industrial policy goals |
| Renew | 77 | FOR | Supported CID resolution; single market and competitiveness alignment |
| PfE | 84 | SPLIT | Industrial support yes, but European preference in procurement may face resistance from some national delegations |
| ECR | 78 | SPLIT | Pro-industry but sceptical of EU-level procurement rules and green conditionality |
| Greens/EFA | 53 | FOR with amendments | Will push for stronger environmental criteria and faster timelines |
| The Left | 46 | FOR with amendments | Will push for stronger worker protections and public ownership provisions |
| ESN | 25 | AGAINST | Generally opposed to EU regulatory frameworks |
| NI | 33 | SPLIT | No unified position expected |

### Predicted Plenary Outcome

| Metric | Prediction | Confidence |
|--------|-----------|------------|
| **Overall result** | ADOPTED in first reading or early second reading | Medium |
| **Estimated FOR votes** | 450-520 (out of 720) | Low |
| **Key coalition** | EPP + S&D + Renew (core), with Greens and Left conditional support | Medium |
| **Main friction points** | European preference scope, green conditionality stringency, funding adequacy | Medium |
| **Timeline** | Committee report: Q4 2026; Plenary first reading: Q1-Q2 2027 | Low |

### Prediction Basis

1. **EP Resolution alignment:** The CID resolution (June 2025) was adopted with broad cross-party support. The IAA directly implements Parliament's own requests, creating political momentum for adoption.
2. **Industrial competitiveness framing:** The proposal is framed as competitiveness (not just green regulation), which attracts broader political support including centre-right.
3. **Clean Industrial Deal package:** Part of a flagship Commission initiative with strong political backing from EVP Sejourne.
4. **Net-Zero Industry Act precedent:** NZIA was adopted with 361 votes to 121 (75%) in February 2024. The IAA has a similar industrial policy profile.

### Resolution Leading Indicator

The CID resolution (2025/2656(RSP)) serves as a **strong leading indicator** for the IAA vote:
- **Match type:** COMMISSION_FOLLOWUP (confidence: 0.9)
- **Signal:** Parliament explicitly called for the measures now proposed in the IAA
- **Implication:** High likelihood of cross-party support in committee and plenary

## Related Brubru Features

- **My EU Bubble**: Track this legislative file through My Files
- **Amendator**: Draft amendments to the Regulation proposal
- **Predictions**: Vote prediction for EP plenary
- **Brubru Chat**: Ask about the Industrial Accelerator Act, its provisions, and legislative progress
