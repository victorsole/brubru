# SAFE Instrument and ReArm Europe (Readiness 2030)
...
The SAFE instrument is the EU's first large-scale defence financing mechanism. Announced as part of the "ReArm Europe" plan (later rebranded "Readiness 2030"), it provides up to EUR 150 billion in voluntary loans to participating Member States for defence investment. This represents a paradigm shift: the EU borrowing on capital markets to fund defence -- something unthinkable before Russia's full-scale invasion of Ukraine.

## Readiness 2030 Package (EUR 800 billion total)

| Component | Amount | Mechanism |
|-----------|--------|-----------|
| SAFE instrument | EUR 150B | EU loans to Member States (voluntary) |
| National fiscal space | EUR 650B | Activation of SGP escape clause for defence spending |
| EDIP | EUR 1.5B | Direct EU grants for defence industry (2025-2027) |
| EDF | EUR 7.95B | Defence R&D and capability development (2021-2027) |
| Private capital | TBD | EIB defence lending, securitisation, defence bonds |

## SAFE -- Key Features

- **Voluntary participation**: Member States opt in; 19 of 27 participating as of March 2026
- **EU borrowing**: Commission borrows on capital markets (AAA-rated EU bonds), on-lends to Member States
- **Eligible spending**: Joint procurement of defence equipment, ammunition, infrastructure, maintenance, training
...
| Body | Role |
|------|------|
| DG DEFIS | Lead Commission DG |
| Commissioner Kubilius | Defence and Space portfolio |
| SEDE subcommittee (EP) | Security and Defence oversight |
| FAC (Defence) Council | Council configuration for defence |
| European Defence Agency (EDA) | Capability planning, joint procurement coordination |
| NATO | Strategic alignment, 5% GDP target by 2035 |

## Related Legislation

| Legislation | CELEX | Relationship |
|-------------|-------|-------------|
| EDIP Regulation (EU) 2025/2643 | 32025R2643 | EU defence industry programme |
| European Defence Fund Regulation (EU) 2021/697 | 32021R0697 | R&D grants for defence |
...
For comprehensive analysis of EU defence policy, including EDIS, EDIP, SAFE, and the EU Space Strategy for Security and Defence, check the **Defence Intelligence Monitor** by Beresol -- free data, updated daily: https://beresol.eu/defence
