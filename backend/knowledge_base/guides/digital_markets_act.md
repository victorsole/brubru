...
- **LATEST (Wednesday 8 July 2026 -- GENERAL COURT UPHOLDS APPLE'S GATEKEEPER DESIGNATION)**: The **General Court (Eighth Chamber, extended composition)** dismissed **Apple's three actions** challenging its DMA gatekeeper status. It **upheld the Commission's designation of Apple as a gatekeeper for the App Store and iOS** (6 September 2023 designation); **rejected Apple's bid to have its five App Stores** (iPhone, iPad, Apple Watch, Mac, Apple TV) **treated as separate core platform services**, holding that each performs the same function of connecting developers with end users; and ruled **inadmissible** Apple's separate action contesting the Commission's classification of **iMessage as a number-independent interpersonal communications service (NIICS)**. Apple therefore **remains bound by DMA obligations** (permitting alternative app stores, interoperability, no self-preferencing) and may **appeal on points of law to the Court of Justice** within two months. Apple is separately contesting a **EUR 500 million penalty** for App Store anti-steering breaches. Case numbers pending citation (curia.europa.eu, judgments of 8 July 2026). Source: General Court + Commission, 8 July 2026.
- **PRIOR (Wednesday 1 July 2026)**: The Commission **hosted a stakeholder roundtable on cloud computing services under the DMA**. Cloud computing services are one of the ten core platform services (CPS) listed in Article 2(2), but no cloud provider has yet been designated a gatekeeper; the roundtable gathered market participants to examine the sector's contestability. This is a scoping/consultation step, not a designation decision. Source: European Commission newsroom, 1 July 2026.
