...
- **LATEST (23 July 2026, summary published in the OJ on 25 September 2026): Alphabet fined EUR 460 million for Google Search self-preferencing (Article 6(5))**, case DMA.100193, decision C(2026) 5358 final (Articles 29, 30 and 31). Google Search ranks Alphabet's own distinct services more favourably than similar third-party services: Google Maps (directions and address buttons reserved for it), the product-ads, products, flights, trains, lodging and places units (rich format above organic results, fed only by sites that give Alphabet data feeds), and the translation, sports and games units. **Cease-and-desist: comply within 60 calendar days of notification**, then periodic penalty payments are possible (Article 31). Alphabet chooses how: from giving third parties equal prominence to removing its own services' prominence. The same month the Commission also decided **DMA.100075, Google Play, Article 5(4)** (anti-steering; register date 23 July 2026; OJ summary not yet published, so do not state its content or fine). Earlier DMA non-compliance decisions: Apple, App Store anti-steering, Article 5(4) (DMA.100109, 23 April 2025) and Meta, 'pay or consent', Article 5(2) (DMA.100055, 22 April 2025). Source: OJ C/2026/4985; https://digital-markets-act-cases.ec.europa.eu/cases/DMA.100193
- **EARLIER (Wednesday 2 September 2026 — THE EDGE GATEKEEPER JUDGMENT IS DELIVERED):** in **Case T-357/24, Opera Norway v Commission**, the **General Court dismissed Opera Norway's action in its entirety** and **upheld the Commission's decision of 12 February 2024 not to designate Microsoft as a gatekeeper in respect of Microsoft Edge**. This is the first judicial test of the **Article 3(5) rebuttal**: Microsoft **did meet the quantitative thresholds**, and the Court confirmed it had put forward sufficiently substantiated arguments that Edge is **not an 'important gateway'** for business users to reach end users. Three findings the Court endorsed: the Commission could rely on **Edge's low scale of usage** compared with other browsers; **Edge runs on the Blink browser engine**, which reduces Microsoft's ability to exercise autonomous control over key aspects of the service; and **pre-installation on Windows plus the other mechanisms promoting Edge did not contribute enough** to make it an important gateway. Opera Norway was held **directly and individually concerned**, so it had standing. Meeting the thresholds is a presumption, not a designation, and the rebuttal can succeed. Source: CJEU press release No 113/26, 2 September 2026, https://curia.europa.eu/site/upload/docs/application/pdf/2026-09/cp260113en.pdf
- **PRIOR (8 July 2026 — APPLE'S DESIGNATION UPHELD):** in **Case T-1080/23, Apple v Commission** the General Court **dismissed Apple's action** and upheld its designation as gatekeeper for the **App Store** (and the related iOS/iPadOS services). Read together with T-357/24 below, the two judgments mark the boundary: Apple could not rebut, Microsoft could. Detail in the body.
- **PRIOR (1 July 2026):** Commission stakeholder roundtable on cloud computing (DMA market investigation).
