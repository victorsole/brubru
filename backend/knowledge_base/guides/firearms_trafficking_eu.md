...
- 26 February 2026: Commission proposal published (COM(2026) 102)
- 27 February 2026: SEC(2026) 102 staff working document attached
- 25 March 2026: Council Working Party on Substantive Criminal Law starts examination
- 20 April 2026: LIBE rapporteur Evin Incir (S&D, SE) appointed
- 29 April 2026: LIBE draft report announcement visible in EP committees portal

## Key elements (preliminary, based on Commission proposal title and DG HOME priorities)
- Common definitions of firearms-related offences (manufacturing, trafficking, conversion, illicit possession)
- Minimum maximum penalties (Article 83 TFEU framework)
- Cross-border evidence sharing (ballistic data, weapon serial numbers)
- Strengthened cooperation with Europol's EMPACT firearms priority
- Alignment with the UN Firearms Protocol and Arms Trade Treaty

## Cross-feature signals
- **Chat**: surface alongside `csam_regulation_online`, `eu_drugs_agency_euda`, and `dark_web_cybersecurity` for users on the JHA cluster
- **My Files**: add 2026/0059(COD) to the suggested-files list
- **Tracker**: TABLED status, watch for committee referral and rapporteur draft report deadline
- **Comply**: future obligation row once adopted (Member State criminal-law transposition)
