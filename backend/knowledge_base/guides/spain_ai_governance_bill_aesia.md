...
## QUICK FACTS
- **The bill**: *Proyecto de Ley Orgánica para el buen uso y la gobernanza de la inteligencia artificial*, BOCG Congreso Serie A núm. 97-1, **12 June 2026** (file 121/000096; amendments closed 30 June 2026). **Still a bill** as of 15 Sep 2026, not law.
- **What it does**: Spain's implementing law for the **EU AI Act** (Reg (EU) 2024/1689). **No new obligations for companies**: it designates authorities, sets national sanctions and procedure, runs the sandbox, and regulates the central State's own AI use. 41 articles; organic-law rank only for Arts 21.3, 28 and Final Provision 3.
- **Drafted before the Digital Omnibus on AI** (Reg (EU) 2026/1744, in force 27 July 2026) and does not reflect it. **Late**: authorities and penalties were due **2 August 2025**.
- **AESIA** (Agencia Española de Supervisión de Inteligencia Artificial, A Coruña): single point of contact, **default market surveillance authority**, national sandbox, single complaints window (routes complaints in 10 working days); becomes an independent entity within 6 months.
- **WHO SUPERVISES WHAT (Art 5)**: **Credit scoring / creditworthiness AI -> Banco de España or CNMV** (by who supervises the firm), NOT AESIA or the CGPJ. **Life and health insurance pricing -> DGSFP.** **AEPD + regional DPAs**: facial scraping databases, biometric categorisation, biometrics outside police/justice/elections, migration and borders. **CGPJ (judiciary)**: crime-risk prediction, police real-time facial recognition, law enforcement and justice systems. **AESIA**: manipulation, social scoring, emotion recognition at work/school, critical infrastructure, education, employment, public services, chatbots and deepfake labelling, radio equipment, elections (once independent), anything unassigned. **Annex I products**: existing sectoral regulators.
- **Notifying authority**: Dirección General de Inteligencia Artificial with ENAC.
- **Fines (Art 30)**: prohibited practices **EUR 35M / 7%**; not reporting a serious incident **EUR 15M / 3%**; serious (most high-risk and transparency breaches) **EUR 7.5M / 1%**, below the AI Act's EUR 15M / 3% ceiling; minor **EUR 500k / 0.5%**. SMEs pay the lower figure. **Public bodies are not fined** (warnings and corrective orders, Art 39). Reductions 25% + 25% (Art 40).
- **Gaps vs the AI Act as amended**: no offence for the two new Omnibus prohibitions (non-consensual intimate imagery, CSAM; apply 2 Dec 2026); no small mid-cap fine cap; no value-chain (Art 25) offence; ignores AI Office exclusive supervision (Art 75); no national rules for police real-time facial recognition (AI Act Art 5(5)), so none can lawfully be authorised.
