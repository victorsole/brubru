...
GUIDE_KEYWORD_TRIGGERS: Dict[str, List[str]] = {
    ...
    'ecdc': ['eu_health_security_framework'],
    ...
    'ep governing bodies': ['ep_governing_bodies'],
    'how is the european parliament run': ['ep_governing_bodies'],
    'conference of presidents': ['ep_governing_bodies'],
    'bureau of the european parliament': ['ep_governing_bodies'],
    'quaestors': ['ep_governing_bodies'],
    'conference of committee chairs': ['ep_governing_bodies'],
    'who sets the plenary agenda': ['ep_governing_bodies'],
