...
GUIDE_KEYWORD_TRIGGERS: Dict[str, List[str]] = {
    ...
    'ema': ['eu_pharmaceutical_framework', 'eu_public_health'],
    'european medicines agency': ['eu_pharmaceutical_framework', 'eu_public_health'],
    ...
    'critical medicines': ['critical_medicines_act', 'eu_public_health'],
