...
GUIDE_KEYWORD_TRIGGERS: Dict[str, List[str]] = {
    ...
    'european council': ['iran_strait_hormuz_eu_response', 'ep_plenary_march_2026'],
    'european council march': ['iran_strait_hormuz_eu_response'],
    'euco': ['iran_strait_hormuz_eu_response'],
    'eu summit': ['iran_strait_hormuz_eu_response'],
    'eu leaders summit': ['iran_strait_hormuz_eu_response'],
    ...
    'water framework directive': ['eu_water_legislation'],
