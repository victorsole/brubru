...
GUIDE_KEYWORD_TRIGGERS: Dict[str, List[str]] = {
    ...
    # /news 19 Aug 2026 — ECHA's first implementing workstream off the ELV Regulation
    'hazardous substances in vehicles': ['end_of_life_vehicles_regulation'],
    'echa vehicles substances': ['end_of_life_vehicles_regulation'],
    'substancies perilloses vehicles': ['end_of_life_vehicles_regulation'],
    'sustancias peligrosas vehiculos': ['end_of_life_vehicles_regulation'],
    ...
    # Adopted as Regulation (EU) 2026/1738, in force 13 August 2026 — triggers added
    # that day, because a user asking by the act number found nothing before it.
    '2026/1738': ['end_of_life_vehicles_regulation'],
    '32026r1738': ['end_of_life_vehicles_regulation'],
    'regulation 2026/1738': ['end_of_life_vehicles_regulation'],
    'vehicle circularity regulation': ['end_of_life_vehicles_regulation'],
    'digital circularity vehicle passport': ['end_of_life_vehicles_regulation'],
    'circularity vehicle passport': ['end_of_life_vehicles_regulation'],
    'vehicle passport': ['end_of_life_vehicles_regulation'],
    'authorised treatment facility': ['end_of_life_vehicles_regulation'],
    'certificate of destruction': ['end_of_life_vehicles_regulation'],
    'used vehicle export': ['end_of_life_vehicles_regulation'],
    'recycled plastic vehicles': ['end_of_life_vehicles_regulation'],
    'pasaporte de circularidad del vehiculo': ['end_of_life_vehicles_regulation'],
    'reglamento vehiculos fuera de uso': ['end_of_life_vehicles_regulation'],
    'passaport de circularitat del vehicle': ['end_of_life_vehicles_regulation'],
    'reglament vehicles fora d us': ['end_of_life_vehicles_regulation'],
    'passeport de circularite du vehicule': ['end_of_life_vehicles_regulation'],
    'reglement vehicules hors d usage': ['end_of_life_vehicles_regulation'],
    'passaporto di circolarita del veicolo': ['end_of_life_vehicles_regulation'],
    'autovoertuigen einde levensduur': ['end_of_life_vehicles_regulation'],
    ...
    # 'fraud' alone used to point only at the EU Financial Regulation procurement
    # guide, so every payment-fraud question landed on procurement (verified
    # 17 Aug 2026: a PSD2 question returned MiFID II + procurement + EIC).
    # Keep procurement reachable, but let the payment-fraud guide compete.
    # ---- EU payment services + payment fraud (added 19 August 2026) ----
    # Two guides plus the existing Eurosystem-infrastructure guide. Triggers are
    # written as people actually type them, in EN/ES/CA/FR/IT/NL, because a guide
    # reachable only by a bare identifier is unreachable in practice.
    # -- the regime --
    'psd2': ['eu_payment_services_psd2_psd3'],
    'directiva de servicios de pago': ['eu_payment_services_psd2_psd3'],
    'reglamento de servicios de pago': ['eu_payment_services_psd2_psd3'],
    'servicios de pago': ['eu_payment_services_psd2_psd3'],
    'serveis de pagament': ['eu_payment_services_psd2_psd3'],
    'directive sur les services de paiement': ['eu_payment_services_psd2_psd3'],
    'servizi di pagamento': ['eu_payment_services_psd2_psd3'],
    'betalingsdiensten': ['eu_payment_services_psd2_psd3'],
    'real decreto-ley 19/2018': ['eu_payment_services_psd2_psd3'],
    'rdl 19/2018': ['eu_payment_services_psd2_psd3'],
    'strong customer authentication': ['eu_payment_services_psd2_psd3'],
    'autenticacion reforzada': ['eu_payment_services_psd2_psd3'],
    'autenticacion reforzada de cliente': ['eu_payment_services_psd2_psd3'],
    'sca payments': ['eu_payment_services_psd2_psd3'],
    'payment institution licence': ['eu_payment_services_psd2_psd3'],
    'entidad de pago': ['eu_payment_services_psd2_psd3'],
    # -- verification of payee: content already existed but was unreachable --
    'verification of payee': ['eu_payment_services_psd2_psd3', 'target_services_payment_systems'],
    'vop': ['eu_payment_services_psd2_psd3', 'target_services_payment_systems'],
    'verificacion del beneficiario': ['eu_payment_services_psd2_psd3', 'target_services_payment_systems'],
    'verificacio del beneficiari': ['eu_payment_services_psd2_psd3', 'target_services_payment_systems'],
    'comprobacion del beneficiario': ['eu_payment_services_psd2_psd3', 'target_services_payment_systems'],
    'nombre del beneficiario transferencia': ['eu_payment_fraud_consumer_redress', 'eu_payment_services_psd2_psd3'],
    'iban name check': ['eu_payment_services_psd2_psd3', 'target_services_payment_systems'],
    'instant payments regulation': ['target_services_payment_systems', 'eu_payment_services_psd2_psd3'],
    'transferencias inmediatas': ['target_services_payment_systems', 'eu_payment_services_psd2_psd3'],
    'transferencia sepa inmediata': ['eu_payment_fraud_consumer_redress', 'target_services_payment_systems'],
    'sepa instant': ['target_services_payment_systems', 'eu_payment_services_psd2_psd3'],
    # -- fraud and redress, the phrasing a victim or their lawyer uses --
    'payment fraud': ['eu_payment_fraud_consumer_redress'],
    'bank fraud refund': ['eu_payment_fraud_consumer_redress'],
    'unauthorised payment transaction': ['eu_payment_fraud_consumer_redress'],
    'unauthorized transaction refund': ['eu_payment_fraud_consumer_redress'],
    'operacion de pago no autorizada': ['eu_payment_fraud_consumer_redress'],
    'operaciones no autorizadas': ['eu_payment_fraud_consumer_redress'],
    'transferencia no autorizada': ['eu_payment_fraud_consumer_redress'],
    'me han estafado': ['eu_payment_fraud_consumer_redress'],
    'me han estafado el banco': ['eu_payment_fraud_consumer_redress'],
    'estafa bancaria': ['eu_payment_fraud_consumer_redress'],
    'estafa telefonica banco': ['eu_payment_fraud_consumer_redress'],
    'suplantacion del banco': ['eu_payment_fraud_consumer_redress'],
    'suplantacion de identidad bancaria': ['eu_payment_fraud_consumer_redress'],
    'devolucion banco estafa': ['eu_payment_fraud_consumer_redress'],
    'reclamar al banco estafa': ['eu_payment_fraud_consumer_redress'],
    'el banco no me devuelve el dinero': ['eu_payment_fraud_consumer_redress'],
    'negligencia grave banco': ['eu_payment_fraud_consumer_redress'],
    'carga de la prueba banco': ['eu_payment_fraud_consumer_redress'],
    'phishing bancario': ['eu_payment_fraud_consumer_redress'],
    'vishing': ['eu_payment_fraud_consumer_redress'],
    'smishing': ['eu_payment_fraud_consumer_redress'],
    'spoofing bancario': ['eu_payment_fraud_consumer_redress'],
    'bizum estafa': ['eu_payment_fraud_consumer_redress'],
    'estafa por bizum': ['eu_payment_fraud_consumer_redress'],
    'fraude bizum': ['eu_payment_fraud_consumer_redress'],
    'estafa amb bizum': ['eu_payment_fraud_consumer_redress'],
    'm han estafat': ['eu_payment_fraud_consumer_redress'],
    'estafa bancaria catala': ['eu_payment_fraud_consumer_redress'],
    'fraude bancaire remboursement': ['eu_payment_fraud_consumer_redress'],
    'virement non autorise': ['eu_payment_fraud_consumer_redress'],
    'frode bancaria rimborso': ['eu_payment_fraud_consumer_redress'],
    'bonifico non autorizzato': ['eu_payment_fraud_consumer_redress'],
    'bankfraude terugbetaling': ['eu_payment_fraud_consumer_redress'],
    'ongeautoriseerde betaling': ['eu_payment_fraud_consumer_redress'],
    'impersonation fraud': ['eu_payment_fraud_consumer_redress', 'eu_payment_services_psd2_psd3'],
    'authorised push payment fraud': ['eu_payment_fraud_consumer_redress', 'eu_payment_services_psd2_psd3'],
    'app fraud': ['eu_payment_fraud_consumer_redress'],
    'app fraud liability': ['eu_payment_fraud_consumer_redress', 'eu_payment_services_psd2_psd3'],
    'd+1 refund': ['eu_payment_fraud_consumer_redress'],
    'reembolso inmediato': ['eu_payment_fraud_consumer_redress'],
    'gross negligence payment': ['eu_payment_fraud_consumer_redress'],
    'c-70/25': ['eu_payment_fraud_consumer_redress'],
    'tukowiecka': ['eu_payment_fraud_consumer_redress'],
    'psr article 59': ['eu_payment_services_psd2_psd3', 'eu_payment_fraud_consumer_redress'],
    'articulo 59 psr': ['eu_payment_services_psd2_psd3', 'eu_payment_fraud_consumer_redress'],
    'transaction monitoring obligation': ['eu_payment_fraud_consumer_redress', 'eu_payment_services_psd2_psd3'],
    'supervision de operaciones banco': ['eu_payment_fraud_consumer_redress'],
    'servicio de atencion al cliente banco plazo': ['eu_payment_fraud_consumer_redress'],
    'reclamacion banco de espana': ['eu_payment_fraud_consumer_redress'],
    'fraud': ['eu_payment_fraud_consumer_redress', 'eu_financial_regulation_procurement'],
    ...
    'fta': ['eu_trade_policy'],
    'ceta': ['eu_canada_relations', 'eu_trade_policy'],  # /news 27 Aug 2026: canonical (a duplicate exists ABOVE and is dead)
    # /news 27 Aug 2026 - EU-Canada: EP recommendation P10_TA(2026)0078 (52026IP0078)
    # published in the OJ C-series. No guide covered Canada at all before today.
    # /news 27 Aug 2026 - children, social media and age limits in the EU.
    # The distinguishing fact this guide exists to protect: the EU has NOT banned
    # social media for children. Parliament asked for 16 (non-binding), 25 of 27
    # Member States signed a declaration (non-binding), the Commission recommended
    # age-verification technology (non-binding). Only DSA duties bind, and they set
    # no age.
    'digital minimum age': ['eu_minors_social_media_age_limits'],
    'minimum age social media': ['eu_minors_social_media_age_limits'],
    'minimum age for social media': ['eu_minors_social_media_age_limits'],
    'social media ban children': ['eu_minors_social_media_age_limits'],
    'social media ban for children': ['eu_minors_social_media_age_limits'],
    'ban social media minors': ['eu_minors_social_media_age_limits'],
    'social media age limit': ['eu_minors_social_media_age_limits'],
    'age limit social media': ['eu_minors_social_media_age_limits'],
    'jutland declaration': ['eu_minors_social_media_age_limits'],
    'digital majority age': ['eu_minors_social_media_age_limits'],
    'digital legal age': ['eu_minors_social_media_age_limits'],
    'digital age of consent': ['eu_minors_social_media_age_limits'],
    'minors online': ['eu_minors_social_media_age_limits'],
    'protection of minors online': ['eu_minors_social_media_age_limits'],
    'schaldemose': ['eu_minors_social_media_age_limits'],
    'ruotolo': ['eu_minors_social_media_age_limits'],
    'addictive design': ['eu_minors_social_media_age_limits', 'dsa_enforcement'],
    'infinite scroll': ['eu_minors_social_media_age_limits'],
    'ai companions': ['eu_minors_social_media_age_limits'],
    'under 16 social media': ['eu_minors_social_media_age_limits'],
    'under-16 social media': ['eu_minors_social_media_age_limits'],
    'kids social media eu': ['eu_minors_social_media_age_limits'],
    'children social media eu': ['eu_minors_social_media_age_limits'],
    # ES
    'edad minima redes sociales': ['eu_minors_social_media_age_limits'],
    'prohibir redes sociales menores': ['eu_minors_social_media_age_limits'],
    'mayoria de edad digital': ['eu_minors_social_media_age_limits'],
    'menores y redes sociales': ['eu_minors_social_media_age_limits'],
    # CA
    'edat minima xarxes socials': ['eu_minors_social_media_age_limits'],
    'prohibir xarxes socials menors': ['eu_minors_social_media_age_limits'],
    'majoria d\'edat digital': ['eu_minors_social_media_age_limits'],
    # FR
    'age minimum reseaux sociaux': ['eu_minors_social_media_age_limits'],
    'majorite numerique': ['eu_minors_social_media_age_limits'],
    'interdire les reseaux sociaux aux mineurs': ['eu_minors_social_media_age_limits'],
    # IT / NL / DE
    'eta minima social media': ['eu_minors_social_media_age_limits'],
    'mindestalter soziale medien': ['eu_minors_social_media_age_limits'],
    'banned social media for children': ['eu_minors_social_media_age_limits'],
    'ban social media for children': ['eu_minors_social_media_age_limits'],
    'banning social media for children': ['eu_minors_social_media_age_limits'],
    'ban on social media for children': ['eu_minors_social_media_age_limits'],
    'banned social media for minors': ['eu_minors_social_media_age_limits'],
    'ban social media for minors': ['eu_minors_social_media_age_limits'],
    'social media for children': ['eu_minors_social_media_age_limits'],
    'social media for minors': ['eu_minors_social_media_age_limits'],
    'children use social media': ['eu_minors_social_media_age_limits'],
    'kids off social media': ['eu_minors_social_media_age_limits'],
    'age check social media': ['eu_minors_social_media_age_limits'],
    'age assurance': ['eu_minors_social_media_age_limits'],
    'edat mínima per a les xarxes socials': ['eu_minors_social_media_age_limits'],
    'edat mínima xarxes socials': ['eu_minors_social_media_age_limits'],
    'edat mínima per a xarxes socials': ['eu_minors_social_media_age_limits'],
    'xarxes socials menors': ['eu_minors_social_media_age_limits'],
    'menors xarxes socials': ['eu_minors_social_media_age_limits'],
    'xarxes socials i menors': ['eu_minors_social_media_age_limits'],
    'prohibir les xarxes socials': ['eu_minors_social_media_age_limits'],
    'edat mínima': ['eu_minors_social_media_age_limits'],
    'majoria d’edat digital': ['eu_minors_social_media_age_limits'],
    'edad mínima redes sociales': ['eu_minors_social_media_age_limits'],
    'edad mínima para las redes sociales': ['eu_minors_social_media_age_limits'],
    'redes sociales a los menores': ['eu_minors_social_media_age_limits'],
    'prohibido las redes sociales': ['eu_minors_social_media_age_limits'],
    'prohibir las redes sociales': ['eu_minors_social_media_age_limits'],
    'menores redes sociales': ['eu_minors_social_media_age_limits'],
    'redes sociales y menores': ['eu_minors_social_media_age_limits'],
    'edad mínima': ['eu_minors_social_media_age_limits'],
    'mayoría de edad digital': ['eu_minors_social_media_age_limits'],
    'âge minimum pour les réseaux sociaux': ['eu_minors_social_media_age_limits'],
    'âge minimum réseaux sociaux': ['eu_minors_social_media_age_limits'],
    'réseaux sociaux mineurs': ['eu_minors_social_media_age_limits'],
    'mineurs réseaux sociaux': ['eu_minors_social_media_age_limits'],
    'interdire les réseaux sociaux': ['eu_minors_social_media_age_limits'],
    'majorité numérique': ['eu_minors_social_media_age_limits'],
    'âge minimum': ['eu_minors_social_media_age_limits'],
    'età minima social media': ['eu_minors_social_media_age_limits'],
    'social media minori': ['eu_minors_social_media_age_limits'],
    'minori social media': ['eu_minors_social_media_age_limits'],
    'minimumleeftijd sociale media': ['eu_minors_social_media_age_limits'],
    'sociale media minderjarigen': ['eu_minors_social_media_age_limits'],
    'età minima per i social media': ['eu_minors_social_media_age_limits'],
    'età minima per i social': ['eu_minors_social_media_age_limits'],
    'età minima': ['eu_minors_social_media_age_limits'],
    'eta minima': ['eu_minors_social_media_age_limits'],
    'social media e minori': ['eu_minors_social_media_age_limits'],
    'vietare i social ai minori': ['eu_minors_social_media_age_limits'],
    'minorenni social media': ['eu_minors_social_media_age_limits'],
    'canada': ['eu_canada_relations'],
    'canadian': ['eu_canada_relations'],
    'canadà': ['eu_canada_relations'],
    'canadá': ['eu_canada_relations'],
    'eu-canada': ['eu_canada_relations'],
    'eu canada': ['eu_canada_relations'],
    'ue-canada': ['eu_canada_relations'],
    'ue canadà': ['eu_canada_relations'],
    'ue canadá': ['eu_canada_relations'],
    'comprehensive economic and trade agreement': ['eu_canada_relations', 'eu_trade_policy'],
    'accord economique et commercial global': ['eu_canada_relations'],
    'acuerdo economico y comercial global': ['eu_canada_relations'],
    'investment court system': ['eu_canada_relations'],
    'sistema de tribunales de inversiones': ['eu_canada_relations'],
    'ceta ratification': ['eu_canada_relations'],
    'ceta provisional application': ['eu_canada_relations'],
    'ceta in force': ['eu_canada_relations'],
    'is ceta in force': ['eu_canada_relations'],
    'eu canada summit': ['eu_canada_relations'],
    'eu canada strategic partnership': ['eu_canada_relations'],
    'strategic partnership agreement canada': ['eu_canada_relations'],
    'canada sovereignty': ['eu_canada_relations'],
    'green alliance canada': ['eu_canada_relations'],
    'mercosur': ['eu_trade_policy'],
    ...
    'general affairs council': ['european_council_and_council_personnel', 'council_guide'],
    'gac meeting': ['european_council_and_council_personnel', 'council_guide'],
    'gac agenda': ['european_council_and_council_personnel', 'council_guide'],
    "consell d'afers generals": ['european_council_and_council_personnel', 'council_guide'],
    'consejo de asuntos generales': ['european_council_and_council_personnel', 'council_guide'],
    'conseil affaires générales': ['european_council_and_council_personnel', 'council_guide'],
    'consiglio affari generali': ['european_council_and_council_personnel', 'council_guide'],
    'raad algemene zaken': ['european_council_and_council_personnel', 'council_guide'],
    ...
    'comp committee': ['ema_scientific_committees'],
    'orphan medicinal products committee': ['ema_scientific_committees'],
    'ema comp': ['ema_scientific_committees'],
    ...
    'règlement cyber-résilience': ['cyber_resilience_act'],
    'règlement sur la cyberrésilience': ['cyber_resilience_act'],
    'reglament de ciberresiliència': ['cyber_resilience_act'],
    'regolamento sulla ciberresilienza': ['cyber_resilience_act'],
    'legge sulla ciberresilienza': ['cyber_resilience_act'],
    'cyberweerbaarheidsverordening': ['cyber_resilience_act'],
    'verordening cyberweerbaarheid': ['cyber_resilience_act'],
    'article 14 cyber resilience act': ['cyber_resilience_act'],
    'cra reporting obligations': ['cyber_resilience_act'],
    '24 hour vulnerability reporting': ['cyber_resilience_act'],
    'severe incident reporting manufacturer': ['cyber_resilience_act'],
    ...
    # 19 Aug 2026: these four pointed at the MiFID II guide, which covers markets in
    # financial instruments and says nothing about payment services. That misroute is
    # why a PSD2 question returned MiFID II. Repointed to the payment-services guide;
    # MiFID II is not a fallback here because it is simply a different subject.
    'psd3': ['eu_payment_services_psd2_psd3'],
    'payment services directive': ['eu_payment_services_psd2_psd3'],
    'payment services regulation': ['eu_payment_services_psd2_psd3'],
    'psr': ['eu_payment_services_psd2_psd3'],
    'open banking': ['eu_payment_services_psd2_psd3'],
    ...
    # /news 19 Aug 2026 — Commission Notice 52026XC04514 broadened the national
    # escape clause from defence to energy security. Not one of these phrases
    # was a trigger in any language before today.
    'national escape clause': ['eu_economic_governance_reform_2024', 'safe_rearm_europe'],
    'escape clause energy security': ['eu_economic_governance_reform_2024'],
    'nec for defence': ['eu_economic_governance_reform_2024'],
    'augmented control account': ['eu_economic_governance_reform_2024'],
    'clausula de escape nacional': ['eu_economic_governance_reform_2024'],
    'clausula de salvaguarda nacional': ['eu_economic_governance_reform_2024'],
    'clausula nacional de salvaguarda': ['eu_economic_governance_reform_2024'],
    'clause de sauvegarde nationale': ['eu_economic_governance_reform_2024'],
    'clausola di salvaguardia nazionale': ['eu_economic_governance_reform_2024'],
    'nationale ontsnappingsclausule': ['eu_economic_governance_reform_2024'],
    ...
    'textile fibre labelling': ['textile_fibre_labelling_regulation'],
    'textile labelling regulation': ['textile_fibre_labelling_regulation'],
    'regulation 1007/2011': ['textile_fibre_labelling_regulation'],
    'textile fibre names': ['textile_fibre_labelling_regulation'],
    'fibre composition labelling': ['textile_fibre_labelling_regulation'],
    'clothing label composition eu': ['textile_fibre_labelling_regulation'],
    'how must textiles be labelled eu': ['textile_fibre_labelling_regulation'],
    'contains non-textile parts of animal origin': ['textile_fibre_labelling_regulation'],
    'wool polyester label rules': ['textile_fibre_labelling_regulation'],
    ...
    # EU data centres: energy, water, waste heat, reporting duty (2 Sep 2026).
    # Six languages + DE. Placed at the canonical END so these win over earlier duplicates:
    # a key added ABOVE a duplicate is dead, the LAST entry is the one search_guides sees.
    'data centres eu': ['eu_data_centres_energy_sustainability'],
    'data centers eu': ['eu_data_centres_energy_sustainability'],
    'eu data centre': ['eu_data_centres_energy_sustainability'],
    'eu data center': ['eu_data_centres_energy_sustainability'],
    'data centre energy': ['eu_data_centres_energy_sustainability'],
    'data center energy': ['eu_data_centres_energy_sustainability'],
    'data centre reporting': ['eu_data_centres_energy_sustainability'],
    'data center reporting': ['eu_data_centres_energy_sustainability'],
    'data centre reporting scheme': ['eu_data_centres_energy_sustainability'],
    'data centre energy reporting': ['eu_data_centres_energy_sustainability'],
    'data centre sustainability': ['eu_data_centres_energy_sustainability'],
    'data center sustainability': ['eu_data_centres_energy_sustainability'],
    'data centre water': ['eu_data_centres_energy_sustainability'],
    'data centre water consumption': ['eu_data_centres_energy_sustainability'],
    'data centre waste heat': ['eu_data_centres_energy_sustainability'],
    'waste heat data centres': ['eu_data_centres_energy_sustainability'],
    'waste heat reuse data centre': ['eu_data_centres_energy_sustainability'],
    'data centre electricity consumption': ['eu_data_centres_energy_sustainability'],
    'data centre power consumption': ['eu_data_centres_energy_sustainability'],
    'power usage effectiveness': ['eu_data_centres_energy_sustainability'],
    'pue data centre': ['eu_data_centres_energy_sustainability'],
    'pue eu average': ['eu_data_centres_energy_sustainability'],
    'water usage effectiveness': ['eu_data_centres_energy_sustainability'],
    'wue data centre': ['eu_data_centres_energy_sustainability'],
    'energy reuse factor': ['eu_data_centres_energy_sustainability'],
    'renewable energy factor': ['eu_data_centres_energy_sustainability'],
    'data centre efficiency indicators': ['eu_data_centres_energy_sustainability'],
    'data centre kpi eu': ['eu_data_centres_energy_sustainability'],
    '500 kw data centre': ['eu_data_centres_energy_sustainability'],
    'data centre 500 kw threshold': ['eu_data_centres_energy_sustainability'],
    'how many data centres in the eu': ['eu_data_centres_energy_sustainability'],
    'number of data centres eu': ['eu_data_centres_energy_sustainability'],
    'data centre capacity europe': ['eu_data_centres_energy_sustainability'],
    'installed it power europe': ['eu_data_centres_energy_sustainability'],
    'data centres ireland electricity': ['eu_data_centres_energy_sustainability'],
    'data centre grid connection': ['eu_data_centres_energy_sustainability'],
    'data centre moratorium': ['eu_data_centres_energy_sustainability'],
    'data centre opposition': ['eu_data_centres_energy_sustainability'],
    'data centre protest': ['eu_data_centres_energy_sustainability'],
    'data centre environmental impact assessment': ['eu_data_centres_energy_sustainability'],
    'ai gigafactories funding': ['eu_data_centres_energy_sustainability'],
    'ai gigafactory member states': ['eu_data_centres_energy_sustainability'],
    'eu code of conduct data centre energy efficiency': ['eu_data_centres_energy_sustainability', 'ai_sustainability_eu_framework'],
    'eed article 12 data centres': ['eu_data_centres_energy_sustainability', 'ai_sustainability_eu_framework'],
    'data centre 1 mw threshold reporting': ['eu_data_centres_energy_sustainability', 'ai_sustainability_eu_framework'],
    'pue wue ere data centre': ['eu_data_centres_energy_sustainability', 'ai_sustainability_eu_framework'],
    'ai data centres energy reporting': ['eu_data_centres_energy_sustainability', 'ai_sustainability_eu_framework'],
    'data centre rating scheme': ['eu_data_centres_energy_sustainability'],
    'kronstorf': ['eu_data_centres_energy_sustainability'],
    'data centre austria google': ['eu_data_centres_energy_sustainability'],
    'centros de datos ue': ['eu_data_centres_energy_sustainability'],
    'centros de datos europa': ['eu_data_centres_energy_sustainability'],
    'consumo energetico centros de datos': ['eu_data_centres_energy_sustainability'],
    'consumo energético centros de datos': ['eu_data_centres_energy_sustainability'],
    'centros de datos agua': ['eu_data_centres_energy_sustainability'],
    'centros de datos consumo de agua': ['eu_data_centres_energy_sustainability'],
    'calor residual centros de datos': ['eu_data_centres_energy_sustainability'],
    'centros de datos españa': ['eu_data_centres_energy_sustainability'],
    'centros de datos espana': ['eu_data_centres_energy_sustainability'],
    'centros de datos aragon': ['eu_data_centres_energy_sustainability'],
    'centros de datos aragón': ['eu_data_centres_energy_sustainability'],
    'centros de datos madrid': ['eu_data_centres_energy_sustainability'],
    'moratoria centros de datos': ['eu_data_centres_energy_sustainability'],
    'eficiencia energetica centros de datos': ['eu_data_centres_energy_sustainability'],
    'eficiencia energética centros de datos': ['eu_data_centres_energy_sustainability'],
    'centres de dades ue': ['eu_data_centres_energy_sustainability'],
    'centres de dades europa': ['eu_data_centres_energy_sustainability'],
    'centres de dades catalunya': ['eu_data_centres_energy_sustainability'],
    'megacentres de dades': ['eu_data_centres_energy_sustainability'],
    'consum electric centres de dades': ['eu_data_centres_energy_sustainability'],
    'consum elèctric centres de dades': ['eu_data_centres_energy_sustainability'],
    'centres de dades aigua': ['eu_data_centres_energy_sustainability'],
    'calor residual centres de dades': ['eu_data_centres_energy_sustainability'],
    'pols centres de dades': ['eu_data_centres_energy_sustainability'],
    'moratoria centres de dades': ['eu_data_centres_energy_sustainability'],
    'moratòria centres de dades': ['eu_data_centres_energy_sustainability'],
    'centres de donnees ue': ['eu_data_centres_energy_sustainability'],
    'centres de données ue': ['eu_data_centres_energy_sustainability'],
    'consommation energetique centres de donnees': ['eu_data_centres_energy_sustainability'],
    'consommation énergétique centres de données': ['eu_data_centres_energy_sustainability'],
    'centres de donnees eau': ['eu_data_centres_energy_sustainability'],
    'centres de données eau': ['eu_data_centres_energy_sustainability'],
    'chaleur fatale centres de donnees': ['eu_data_centres_energy_sustainability'],
    'chaleur fatale centres de données': ['eu_data_centres_energy_sustainability'],
    'data center ue consumo': ['eu_data_centres_energy_sustainability'],
    'centri dati ue': ['eu_data_centres_energy_sustainability'],
    'consumo energetico data center': ['eu_data_centres_energy_sustainability'],
    'data center acqua': ['eu_data_centres_energy_sustainability'],
    'calore di scarto data center': ['eu_data_centres_energy_sustainability'],
    'datacenters eu': ['eu_data_centres_energy_sustainability'],
    'datacenters energieverbruik': ['eu_data_centres_energy_sustainability'],
    'datacenters energie verbruik eu': ['eu_data_centres_energy_sustainability', 'ai_sustainability_eu_framework'],
    'datacenters waterverbruik': ['eu_data_centres_energy_sustainability'],
    'restwarmte datacenters': ['eu_data_centres_energy_sustainability'],
    'rechenzentren eu': ['eu_data_centres_energy_sustainability'],
    'rechenzentren energieverbrauch': ['eu_data_centres_energy_sustainability'],
    'abwaerme rechenzentren': ['eu_data_centres_energy_sustainability'],
    # Bare forms, added 2 Sep 2026 after a live retrieval test failed 7 of 8 positives.
    # Triggers are PLAIN SUBSTRING with no connector tolerance: 'data centres eu' can never
    # match 'data centres IN THE eu'. The bare noun is what actually fires.
    'data centre': ['eu_data_centres_energy_sustainability'],
    'data centres': ['eu_data_centres_energy_sustainability'],
    'data center': ['eu_data_centres_energy_sustainability'],
    'data centers': ['eu_data_centres_energy_sustainability'],
    'datacentre': ['eu_data_centres_energy_sustainability'],
    'datacentres': ['eu_data_centres_energy_sustainability'],
    'datacenter': ['eu_data_centres_energy_sustainability'],
    'datacenters': ['eu_data_centres_energy_sustainability'],
    'centre de dades': ['eu_data_centres_energy_sustainability'],
    'centres de dades': ['eu_data_centres_energy_sustainability'],
    'centro de datos': ['eu_data_centres_energy_sustainability'],
    'centros de datos': ['eu_data_centres_energy_sustainability'],
    'centre de données': ['eu_data_centres_energy_sustainability'],
    'centres de données': ['eu_data_centres_energy_sustainability'],
    'centre de donnees': ['eu_data_centres_energy_sustainability'],
    'centres de donnees': ['eu_data_centres_energy_sustainability'],
    'centro dati': ['eu_data_centres_energy_sustainability'],
    ...
    # --- added 7 September 2026 (/news Part 2): C-798/24 shareholder disclosure,
    # Omnibus IV third instrument 2025/0133(COD), the Council's formal first-reading
    # position on the customs code (COM(2026) 436), and the C-320/25 equality trailer.
    # Appended at the END of the literal on purpose: a key added ABOVE an existing
    # duplicate is dead, because the last assignment wins.
    'shareholder disclosure': ['eu_company_law_shareholder_disclosure'],
    'shareholder register': ['eu_company_law_shareholder_disclosure'],
    'public shareholder register': ['eu_company_law_shareholder_disclosure'],
    'minority shareholders': ['eu_company_law_shareholder_disclosure'],
    'publication of shareholders': ['eu_company_law_shareholder_disclosure'],
    'c-798/24': ['eu_company_law_shareholder_disclosure'],
    'jautiva': ['eu_company_law_shareholder_disclosure'],
    'registro de accionistas': ['eu_company_law_shareholder_disclosure'],
    'accionistas minoritarios': ['eu_company_law_shareholder_disclosure'],
    'publicación de accionistas': ['eu_company_law_shareholder_disclosure'],
    'publicacion de accionistas': ['eu_company_law_shareholder_disclosure'],
    "registre d'accionistes": ['eu_company_law_shareholder_disclosure'],
    'accionistes minoritaris': ['eu_company_law_shareholder_disclosure'],
    "publicació d'accionistes": ['eu_company_law_shareholder_disclosure'],
    "publicacio d'accionistes": ['eu_company_law_shareholder_disclosure'],
    'registre des actionnaires': ['eu_company_law_shareholder_disclosure'],
    'actionnaires minoritaires': ['eu_company_law_shareholder_disclosure'],
    'publication des actionnaires': ['eu_company_law_shareholder_disclosure'],
    'registro dei soci': ['eu_company_law_shareholder_disclosure'],
    'azionisti di minoranza': ['eu_company_law_shareholder_disclosure'],
    'aandeelhoudersregister': ['eu_company_law_shareholder_disclosure'],
    'minderheidsaandeelhouders': ['eu_company_law_shareholder_disclosure'],
    '2025/0133': ['eu_omnibus_iv_small_midcap'],
    'com(2025) 503': ['eu_omnibus_iv_small_midcap'],
    'com(2025)503': ['eu_omnibus_iv_small_midcap'],
    'digitalisation and common specifications': ['eu_omnibus_iv_small_midcap'],
    'omnibus iv legal basis': ['eu_omnibus_iv_small_midcap'],
    'omnibus iv imco': ['eu_omnibus_iv_small_midcap'],
    'digitalización y especificaciones comunes': ['eu_omnibus_iv_small_midcap'],
    'digitalizacion y especificaciones comunes': ['eu_omnibus_iv_small_midcap'],
    'digitalització i especificacions comunes': ['eu_omnibus_iv_small_midcap'],
    'digitalitzacio i especificacions comunes': ['eu_omnibus_iv_small_midcap'],
    'numérisation et spécifications communes': ['eu_omnibus_iv_small_midcap'],
    'numerisation et specifications communes': ['eu_omnibus_iv_small_midcap'],
    'digitalizzazione e specifiche comuni': ['eu_omnibus_iv_small_midcap'],
    'digitalisering en gemeenschappelijke specificaties': ['eu_omnibus_iv_small_midcap'],
    'com(2026) 436': ['eu_customs_reform', 'union_customs_code_reform'],
    'com(2026)436': ['eu_customs_reform', 'union_customs_code_reform'],
    'council position on the customs code': ['eu_customs_reform', 'union_customs_code_reform'],
    'customs council first reading': ['eu_customs_reform', 'union_customs_code_reform'],
    'eu customs authority': ['eu_customs_reform', 'union_customs_code_reform'],
    'customs data hub': ['eu_customs_reform', 'union_customs_code_reform', 'eu_customs_electronic_systems'],
    'trust and check trader': ['eu_customs_reform', 'union_customs_code_reform'],
    'importer for distance sales': ['eu_customs_reform', 'union_customs_code_reform'],
    'posición del consejo aduanas': ['eu_customs_reform', 'union_customs_code_reform'],
    'posicion del consejo aduanas': ['eu_customs_reform', 'union_customs_code_reform'],
    'autoridad aduanera de la ue': ['eu_customs_reform', 'union_customs_code_reform'],
    'posició del consell duanes': ['eu_customs_reform', 'union_customs_code_reform'],
    'posicio del consell duanes': ['eu_customs_reform', 'union_customs_code_reform'],
    'autoritat duanera de la ue': ['eu_customs_reform', 'union_customs_code_reform'],
    'position du conseil douanes': ['eu_customs_reform', 'union_customs_code_reform'],
    "autorité douanière de l'ue": ['eu_customs_reform', 'union_customs_code_reform'],
    "autorite douaniere de l'ue": ['eu_customs_reform', 'union_customs_code_reform'],
    'posizione del consiglio dogane': ['eu_customs_reform', 'union_customs_code_reform'],
    "autorità doganale dell'ue": ['eu_customs_reform', 'union_customs_code_reform'],
    "autorita doganale dell'ue": ['eu_customs_reform', 'union_customs_code_reform'],
    'standpunt van de raad douane': ['eu_customs_reform', 'union_customs_code_reform'],
    'douaneautoriteit van de eu': ['eu_customs_reform', 'union_customs_code_reform'],
    'c-320/25': ['eu_equality_antidiscrimination'],
    'lertimene': ['eu_equality_antidiscrimination'],
    'visible tattoo police': ['eu_equality_antidiscrimination'],
    'tattoo discrimination': ['eu_equality_antidiscrimination'],
    'tatuaje policía discriminación': ['eu_equality_antidiscrimination'],
    'tatuaje policia discriminacion': ['eu_equality_antidiscrimination'],
    'tatuatge policia discriminació': ['eu_equality_antidiscrimination'],
    'tatuatge policia discriminacio': ['eu_equality_antidiscrimination'],
    'tatouage police discrimination': ['eu_equality_antidiscrimination'],
    'tatuaggio polizia discriminazione': ['eu_equality_antidiscrimination'],
    'tatoeage politie discriminatie': ['eu_equality_antidiscrimination'],

    # --- item-6 audit follow-up, 7 September 2026: the first C-798/24 trigger set
    # missed the plainest phrasing of the question ('Do all shareholders have to be
    # published?' returned nothing). Natural phrasings, six languages, accented+plain.
    'shareholders have to be published': ['eu_company_law_shareholder_disclosure'],
    'shareholders be published': ['eu_company_law_shareholder_disclosure'],
    'publish shareholders': ['eu_company_law_shareholder_disclosure'],
    'published shareholders': ['eu_company_law_shareholder_disclosure'],
    'all shareholders': ['eu_company_law_shareholder_disclosure'],
    'shareholder names public': ['eu_company_law_shareholder_disclosure'],
    'shareholder transparency': ['eu_company_law_shareholder_disclosure'],
    'shareholder data': ['eu_company_law_shareholder_disclosure'],
    'accionistas publicados': ['eu_company_law_shareholder_disclosure'],
    'publicar accionistas': ['eu_company_law_shareholder_disclosure'],
    'todos los accionistas': ['eu_company_law_shareholder_disclosure'],
    'accionistes publicats': ['eu_company_law_shareholder_disclosure'],
    'publicar accionistes': ['eu_company_law_shareholder_disclosure'],
    'tots els accionistes': ['eu_company_law_shareholder_disclosure'],
    'publier les actionnaires': ['eu_company_law_shareholder_disclosure'],
    'tous les actionnaires': ['eu_company_law_shareholder_disclosure'],
    'pubblicare i soci': ['eu_company_law_shareholder_disclosure'],
    'tutti i soci': ['eu_company_law_shareholder_disclosure'],
    ...
    # --- European Innovation Act + regulatory sandboxes (added 10 September 2026) ---
    'com (2026) 567': ['european_innovation_act'],
    '2026/0264(cod)': ['european_innovation_act'],
    'research and development procurement': ['european_innovation_act'],
    'precommercial procurement': ['european_innovation_act'],
    'intellectual property valuation': ['european_innovation_act'],
    'ip valuator': ['european_innovation_act'],
    'ip backed finance': ['european_innovation_act'],
    'ip marketplace': ['european_innovation_act'],
    'marketplace for ip': ['european_innovation_act'],
    'competence centre for intellectual property': ['european_innovation_act'],
    'union competence centre': ['european_innovation_act'],
    'joint r&d procurement': ['european_innovation_act'],
    'cross-border joint procurement': ['european_innovation_act'],
    'value engineering clause': ['european_innovation_act'],
    'competitive development in phases': ['european_innovation_act'],
    'risk benefit sharing': ['european_innovation_act'],
    'risk-benefit sharing': ['european_innovation_act'],
    'innovation-related award criteria': ['european_innovation_act'],
    'multiple sourcing': ['european_innovation_act'],
    'high-risk supplier': ['european_innovation_act'],
    'eu preference procurement': ['european_innovation_act'],
    'place of performance': ['european_innovation_act'],
    'ley de innovacion europea': ['european_innovation_act'],
    'acto de innovación europea': ['european_innovation_act'],
    'compra pública precomercial': ['european_innovation_act'],
    'compra publica precomercial': ['european_innovation_act'],
    'valoración de la propiedad intelectual': ['european_innovation_act'],
    'llei d\'innovacio europea': ['european_innovation_act'],
    'compra pública precomercial catalana': ['european_innovation_act'],
    'valoració de la propietat intel·lectual': ['european_innovation_act'],
    'acte europeen sur l\'innovation': ['european_innovation_act'],
    'loi européenne sur l\'innovation': ['european_innovation_act'],
    'achat public avant commercialisation': ['european_innovation_act'],
    'valorisation de la propriété intellectuelle': ['european_innovation_act'],
    'appalto pre-commerciale': ['european_innovation_act'],
    'valutazione della proprietà intellettuale': ['european_innovation_act'],
    'precommerciële aanbesteding': ['european_innovation_act'],
    'precommerciele aanbesteding': ['european_innovation_act'],
    'waardering van intellectuele eigendom': ['european_innovation_act'],
    'com(2026) 568': ['regulatory_sandboxes_recommendation'],
    '2026/0267': ['regulatory_sandboxes_recommendation'],
    'cross-border regulatory sandbox': ['regulatory_sandboxes_recommendation'],
    'cross border sandbox': ['regulatory_sandboxes_recommendation'],
    'sandbox exit report': ['regulatory_sandboxes_recommendation'],
    'council recommendation on regulatory sandboxes': ['regulatory_sandboxes_recommendation'],
    'common principles on regulatory sandboxes': ['regulatory_sandboxes_recommendation'],
    'experimentation clause': ['regulatory_sandboxes_recommendation'],
    'controlled environment testing': ['regulatory_sandboxes_recommendation'],
    'regulatory learning': ['regulatory_sandboxes_recommendation'],
    'bac à sable réglementaire': ['regulatory_sandboxes_recommendation'],
    'bac a sable reglementaire': ['regulatory_sandboxes_recommendation'],
    'bacs à sable réglementaires': ['regulatory_sandboxes_recommendation'],
    'espacio controlado de pruebas': ['regulatory_sandboxes_recommendation'],
    'entorno de pruebas regulatorio': ['regulatory_sandboxes_recommendation'],
    'espai controlat de proves': ['regulatory_sandboxes_recommendation'],
    'entorn de proves regulatori': ['regulatory_sandboxes_recommendation'],
    'spazio di sperimentazione normativa': ['regulatory_sandboxes_recommendation'],
    'sandbox normativa': ['regulatory_sandboxes_recommendation'],
    'regelluwe zone': ['regulatory_sandboxes_recommendation'],
    'regelgevingssandbox': ['regulatory_sandboxes_recommendation'],
    'experimenteerruimte': ['regulatory_sandboxes_recommendation'],
