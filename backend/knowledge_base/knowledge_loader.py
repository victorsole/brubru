...
GUIDE_KEYWORD_TRIGGERS: Dict[str, List[str]] = {
    ...
    'ucpm': ['eu_humanitarian_civil_protection', 'wildfire_risk_management'],
    'resceu': ['eu_humanitarian_civil_protection', 'wildfire_risk_management'],
    ...
    'global gateway': ['global_gateway_strategy', 'eu_development_cooperation'],
    'team europe': ['eu_development_cooperation', 'global_gateway_strategy'],
    ...
    'water framework directive': ['eu_water_legislation', 'eu_environment_climate'],
    ...
    'pharmaceutical reform': ['eu_pharmaceutical_reform'],
    'pharma reform': ['eu_pharmaceutical_reform'],
    'pharmaceutical legislation': ['eu_pharmaceutical_reform'],
    'pharma legislation': ['eu_pharmaceutical_reform'],
    'pharmaceutical package': ['eu_pharmaceutical_reform'],
    'medicines legislation': ['eu_pharmaceutical_reform'],
    'data exclusivity': ['eu_pharmaceutical_reform'],
    'market exclusivity': ['eu_pharmaceutical_reform'],
    'orphan medicines': ['eu_pharmaceutical_reform', 'eu_rare_diseases_policy'],
    'orphan drugs': ['eu_pharmaceutical_reform', 'eu_rare_diseases_policy'],
    'antimicrobial resistance': ['eu_pharmaceutical_reform'],
    'amr medicines': ['eu_pharmaceutical_reform'],
    'bolar exemption': ['eu_pharmaceutical_reform'],
    'generic medicines': ['eu_pharmaceutical_reform'],
    'biosimilar': ['eu_pharmaceutical_reform'],
    'marketing authorisation': ['eu_pharmaceutical_reform'],
    'dolors montserrat': ['eu_pharmaceutical_reform'],
    'tiemo wolken': ['eu_pharmaceutical_reform'],
    'tiemo wölken': ['eu_pharmaceutical_reform'],
    '2023/0132': ['eu_pharmaceutical_reform'],
    '2023/0131': ['eu_pharmaceutical_reform'],
    '2023/0132(cod)': ['eu_pharmaceutical_reform'],
    '2023/0131(cod)': ['eu_pharmaceutical_reform'],
    'com(2023)192': ['eu_pharmaceutical_reform'],
    'com(2023)193': ['eu_pharmaceutical_reform'],
    'directive 2001/83': ['eu_pharmaceutical_reform'],
    'regulation 726/2004': ['eu_pharmaceutical_reform'],
    'ema reform': ['eu_pharmaceutical_reform'],
    'reforma farmaceutica': ['eu_pharmaceutical_reform'],
    'reforme pharmaceutique': ['eu_pharmaceutical_reform'],
    'riforma farmaceutica': ['eu_pharmaceutical_reform'],
    'geneesmiddelenwetgeving': ['eu_pharmaceutical_reform'],
    'reforma farmaceutica ue': ['eu_pharmaceutical_reform'],
    ...
    'shortage prevention': ['critical_medicines_act', 'eu_pharmaceutical_reform'],
