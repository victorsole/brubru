...
GUIDE_KEYWORD_TRIGGERS: Dict[str, List[str]] = {
    ...
    'energy prices': ['eu_energy_policy'],
    'energy cost': ['eu_energy_policy'],
    'cost of energy': ['eu_energy_policy'],
    'affordable energy': ['eu_energy_policy'],
    'energy crisis': ['eu_energy_policy'],
    'energy poverty': ['eu_energy_policy'],
    ...
    'clean energy package': ['eu_energy_policy'],
    ...
    'nuclear energy': ['eu_energy_policy'],
    'euratom': ['eu_energy_policy'],
    'nuclear safety': ['eu_energy_policy'],
    ...
    'social climate fund': ['eu_energy_policy'],
    ...
    # SMR and 2026 Energy Package additions
    'small modular reactor': ['eu_energy_policy'],
    'smr': ['eu_energy_policy'],
    'smrs': ['eu_energy_policy'],
    'citizens energy package': ['eu_energy_policy'],
    'clean energy investment': ['eu_energy_policy'],
    'energy package 2026': ['eu_energy_policy'],
    'energy community': ['eu_energy_policy'],
    'energy communities': ['eu_energy_policy'],
    ...
    'defence single market': ['ep_plenary_march_2026'],
    'defence projects': ['ep_plenary_march_2026'],
    'single market defence': ['ep_plenary_march_2026'],
