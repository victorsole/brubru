...
GUIDE_KEYWORD_TRIGGERS: Dict[str, List[str]] = {
    ...
    'health security committee': ['eu_global_health_resilience_initiative_2026', 'critical_medicines_act'],
    'health security committee working group': ['eu_global_health_resilience_initiative_2026'],
    'cross-border health threats': ['eu_global_health_resilience_initiative_2026'],
    'serious cross-border health threats': ['eu_global_health_resilience_initiative_2026'],
    'joint procurement': ['critical_medicines_act', 'eu_global_health_resilience_initiative_2026'],
    'joint procurement of medicines': ['critical_medicines_act'],
    'medical countermeasures': ['eu_global_health_resilience_initiative_2026'],
    'health emergency preparedness': ['eu_global_health_resilience_initiative_2026'],
