...
GUIDE_KEYWORD_TRIGGERS: Dict[str, List[str]] = {
    ...
    'common data platform on chemicals': ['eu_chemicals_common_data_platform_cdpc'],
    ...
    'chemicals data platform eu': ['eu_chemicals_common_data_platform_cdpc'],
    ...
    'article 319 tfeu discharge': ['eu_discharge_procedure_cont'],
