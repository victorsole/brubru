...
GUIDE_KEYWORD_TRIGGERS: Dict[str, List[str]] = {
    ...
    'hungary': ['eu_equality_antidiscrimination'],
    'hungary eu': ['eu_equality_antidiscrimination'],
    'orban': ['eu_equality_antidiscrimination'],
    'orbán': ['eu_equality_antidiscrimination'],
    'fidesz': ['eu_equality_antidiscrimination'],
    'peter magyar': ['eu_equality_antidiscrimination'],
    'tisza party': ['eu_equality_antidiscrimination'],
    'hungary election': ['eu_equality_antidiscrimination'],
    'hongrie': ['eu_equality_antidiscrimination'],
    'hungria': ['eu_equality_antidiscrimination'],
    'ungheria': ['eu_equality_antidiscrimination'],
    'hongarije': ['eu_equality_antidiscrimination'],
    ...
    'apply ai strategy': ['ai_continent_action_plan'],
    'apply ai': ['ai_continent_action_plan'],
    'ai public administration': ['ai_continent_action_plan'],
    'ai public sector': ['ai_continent_action_plan'],
    'govtech': ['ai_continent_action_plan'],
    'ai adoption public': ['ai_continent_action_plan'],
    'jrc ai': ['ai_continent_action_plan'],
    'jrc143539': ['ai_continent_action_plan'],
    'gpt@jrc': ['ai_continent_action_plan'],
    'ai registries': ['ai_continent_action_plan'],
    'public ai registry': ['ai_continent_action_plan'],
    'ai literacy public': ['ai_continent_action_plan'],
    'digital sovereignty ai': ['ai_continent_action_plan'],
    'edih': ['ai_continent_action_plan'],
    'european digital innovation hub': ['ai_continent_action_plan'],
    'genai4eu': ['ai_continent_action_plan'],
    'public sector tech watch': ['ai_continent_action_plan'],
    'pstw': ['ai_continent_action_plan'],
    'ia administracion publica': ['ai_continent_action_plan'],
    'ia administration publique': ['ai_continent_action_plan'],
    'ia pubblica amministrazione': ['ai_continent_action_plan'],
    'ia administracio publica': ['ai_continent_action_plan'],
