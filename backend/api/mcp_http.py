...
def _dpp_instructions(coverage: str) -> str:  # noqa: ARG001 - global coverage is wrong here
    ...
    return (
        ...
        "the apparel-textiles delegated act, the Ecodesign Forum, national draft "
        "rules notified to the Commission (TRIS) with their standstill deadlines, and "
        "the JRC Product Bureau's methodology consultation and textile study.\n\n"
