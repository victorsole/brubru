...
TESTS: list[tuple[str, str, callable]] = [
    ...
    ("/api/v1/commission-register-documents", "expose body", lambda: check_body_field_present("/api/v1/commission-register-documents", ["summary", "body_text", "pdf_text", "description", "common_name"])),
    ...
    ("/api/v1/implementing-acts", "expose content", lambda: check_body_field_present("/api/v1/implementing-acts", ["summary", "body_text", "description"])),
    ...
    ("/api/v1/press-releases", "summary weird, content missing", lambda: check_body_field_present("/api/v1/press-releases", ["body_text", "body_html", "summary"])),
    ...
    ("/api/v1/publications", "missing content", lambda: check_body_field_present("/api/v1/publications", ["summary", "body_text", "body_html"])),
