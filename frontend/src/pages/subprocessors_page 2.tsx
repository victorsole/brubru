      ...
      <div className="policy-page__container">
        ...
        <section className="policy-page__section">
          ...
          <div className="policy-page__subprocessor">
            <h3>Railway Corp.</h3>
            <ul>
              <li><strong>Purpose:</strong> Backend application hosting (FastAPI, PostgreSQL connections, scraper services)</li>
              <li><strong>Data Processed:</strong> Application logs, temporary processing data, cached content</li>
              <li><strong>Data Location:</strong> European Union (Frankfurt region) and United States</li>
              <li><strong>Website:</strong> <a href="https://railway.app" target="_blank" rel="noopener noreferrer" className="policy-page__link">railway.app</a></li>
              <li><strong>DPA:</strong> Standard Contractual Clauses (SCCs) in place</li>
              <li><strong>Privacy Policy:</strong> <a href="https://railway.app/legal/privacy" target="_blank" rel="noopener noreferrer" className="policy-page__link">railway.app/legal/privacy</a></li>
            </ul>
          </div>

          <div className="policy-page__subprocessor">
            <h3>SiteGround Spain S.L.</h3>
            <ul>
              <li><strong>Purpose:</strong> Frontend static hosting, SSL, CDN for brubru.beresol.eu</li>
              <li><strong>Data Processed:</strong> IP addresses, browser data, page requests (minimal personal data)</li>
              <li><strong>Data Location:</strong> European Union (Madrid, Spain)</li>
              <li><strong>Website:</strong> <a href="https://www.siteground.com" target="_blank" rel="noopener noreferrer" className="policy-page__link">siteground.com</a></li>
              <li><strong>DPA:</strong> GDPR-compliant DPA signed</li>
              <li><strong>Privacy Policy:</strong> <a href="https://www.siteground.com/privacy.htm" target="_blank" rel="noopener noreferrer" className="policy-page__link">siteground.com/privacy</a></li>
            </ul>
          </div>
        </section>
