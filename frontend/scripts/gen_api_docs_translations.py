...
LANGS["es"] = {
  ...
  "desc": "Brubru EU Data API v2: 437 endpoints REST en 34 carpetas de instituciones de la UE. 8.710 leyes de la UE, procedimientos legislativos, eurodiputados y funcionarios, enmiendas, las bases de datos de Parlamento / Consejo / Comisi&oacute;n, las bases de datos de las agencias de la UE (medicamentos, seguridad alimentaria, medio ambiente, sustancias qu&iacute;micas, drogas, derechos fundamentales), financiaci&oacute;n, datos abiertos y la inteligencia propia de Brubru sobre la UE. Una sola clave de API.",
  ...
  "eyebrow": "Brubru EU Data API &middot; v2 &middot; 437 endpoints en 34 carpetas de instituciones de la UE",
  "h1": "La UE, estructurada.",
  "lede": "Brubru es un proveedor vertical de datos de la UE. Nuestra API REST da a desarrolladores, plataformas RegTech, equipos de asuntos p&uacute;blicos y agentes de IA acceso program&aacute;tico a <strong>8.710 leyes de la UE adoptadas</strong> (28.513 publicaciones del DO), <strong>1.717 procedimientos legislativos</strong> en curso, <strong>14.873 funcionarios de la UE</strong>, todos los eurodiputados, <strong>56.051 enmiendas</strong>, los registros del Parlamento / Consejo / Consejo Europeo / Eurogrupo / Comisi&oacute;n, el Banco Central Europeo y las instituciones financieras de la UE, las agencias descentralizadas de la UE (medicamentos, seguridad alimentaria, medio ambiente, sustancias qu&iacute;micas, drogas, derechos fundamentales y m&aacute;s), financiaci&oacute;n y licitaciones de la UE, datos abiertos y la propia inteligencia de Brubru sobre la UE. Los mismos datos que usamos internamente son los que usted consulta. Brubru es el primer cliente de su propia API.",
  "box": "<strong>Una superficie, una clave.</strong> La API est&aacute; organizada como la propia UE &mdash; una carpeta por instituci&oacute;n u organismo, 34 carpetas en total, <strong>437 endpoints</strong>. Explore las carpetas a continuaci&oacute;n o abra la <a href=\"/api/docs/reference.html\"><strong>referencia completa y siempre actualizada de la API &rarr;</strong></a> &mdash; cada endpoint desplegado, generado en vivo desde la especificaci&oacute;n OpenAPI.",
  ...
  "ds_p":"Cada carpeta se alimenta de la fuente autorizada de la UE y se actualiza autom&aacute;ticamente. La frecuencia indicada es el peor caso; las carpetas de paso en vivo son en tiempo real.",
  "ds_th":["Capa","Carpetas","Frecuencia de actualizaci&oacute;n"],
  ...
  "next":[
    ("/api/docs/endpoints.html","Todos los endpoints","La lista completa y agrupada de los 437 endpoints de v2, una secci&oacute;n por carpeta de instituci&oacute;n."),
...
LANGS["fr"] = {
  ...
  "desc": "Brubru EU Data API v2 : 437 endpoints REST r&eacute;partis sur 34 dossiers d'institutions de l'UE. 8 710 actes de l'UE, proc&eacute;dures l&eacute;gislatives, d&eacute;put&eacute;s et fonctionnaires, amendements, les bases de donn&eacute;es du Parlement / Conseil / Commission, les bases des agences de l'UE (m&eacute;dicaments, s&eacute;curit&eacute; alimentaire, environnement, produits chimiques, drogues, droits fondamentaux), financements, donn&eacute;es ouvertes et l'intelligence propre de Brubru sur l'UE. Une seule cl&eacute; d'API.",
  ...
  "eyebrow": "Brubru EU Data API &middot; v2 &middot; 437 endpoints sur 34 dossiers d'institutions de l'UE",
  "h1": "L'UE, structur&eacute;e.",
  "lede": "Brubru est un fournisseur vertical de donn&eacute;es de l'UE. Notre API REST donne aux d&eacute;veloppeurs, plateformes RegTech, &eacute;quipes d'affaires publiques et agents d'IA un acc&egrave;s programmatique &agrave; <strong>8 710 actes de l'UE adopt&eacute;s</strong> (28 513 publications du JO), <strong>1 717 proc&eacute;dures l&eacute;gislatives</strong> en cours, <strong>14 873 fonctionnaires de l'UE</strong>, tous les d&eacute;put&eacute;s, <strong>56 051 amendements</strong>, les registres du Parlement / Conseil / Conseil europ&eacute;en / Eurogroupe / Commission, la Banque centrale europ&eacute;enne et les institutions financi&egrave;res de l'UE, les agences d&eacute;centralis&eacute;es de l'UE (m&eacute;dicaments, s&eacute;curit&eacute; alimentaire, environnement, produits chimiques, drogues, droits fondamentaux et plus), financements et appels d'offres de l'UE, donn&eacute;es ouvertes et l'intelligence propre de Brubru sur l'UE. Les m&ecirc;mes donn&eacute;es que nous utilisons en interne sont celles que vous appelez. Brubru est le premier client de sa propre API.",
  "box": "<strong>Une seule surface, une seule cl&eacute;.</strong> L'API est organis&eacute;e comme l'UE elle-m&ecirc;me &mdash; un dossier par institution ou organe, 34 dossiers au total, <strong>437 endpoints</strong>. Parcourez les dossiers ci-dessous ou ouvrez la <a href=\"/api/docs/reference.html\"><strong>r&eacute;f&eacute;rence compl&egrave;te et toujours &agrave; jour de l'API &rarr;</strong></a> &mdash; chaque endpoint d&eacute;ploy&eacute;, g&eacute;n&eacute;r&eacute; en direct depuis la sp&eacute;cification OpenAPI.",
  ...
  "ds_p":"Chaque dossier est aliment&eacute; par la source faisant autorit&eacute; de l'UE et mis &agrave; jour automatiquement. La fr&eacute;quence indiqu&eacute;e est le pire cas&nbsp;; les dossiers en passe-plat direct sont en temps r&eacute;el.",
  "ds_th":["Couche","Dossiers","Fr&eacute;quence de mise &agrave; jour"],
  ...
  "next":[
    ("/api/docs/endpoints.html","Tous les endpoints","La liste compl&egrave;te et regroup&eacute;e des 437 endpoints v2, une section par dossier d'institution."),
...
LANGS["it"] = {
  ...
  "desc": "Brubru EU Data API v2: 437 endpoint REST in 34 cartelle di istituzioni dell'UE. 8.710 atti dell'UE, procedure legislative, deputati e funzionari, emendamenti, le banche dati di Parlamento / Consiglio / Commissione, le banche dati delle agenzie dell'UE (medicinali, sicurezza alimentare, ambiente, sostanze chimiche, droghe, diritti fondamentali), finanziamenti, dati aperti e l'intelligence propria di Brubru sull'UE. Una sola chiave API.",
  ...
  "eyebrow": "Brubru EU Data API &middot; v2 &middot; 437 endpoint in 34 cartelle di istituzioni dell'UE",
  "h1": "L'UE, strutturata.",
  "lede": "Brubru &egrave; un fornitore verticale di dati dell'UE. La nostra API REST offre a sviluppatori, piattaforme RegTech, team di affari pubblici e agenti di IA accesso programmatico a <strong>8.710 atti dell'UE adottati</strong> (28.513 pubblicazioni della GU), <strong>1.717 procedure legislative</strong> in corso, <strong>14.873 funzionari dell'UE</strong>, tutti i deputati, <strong>56.051 emendamenti</strong>, i registri di Parlamento / Consiglio / Consiglio europeo / Eurogruppo / Commissione, la Banca centrale europea e le istituzioni finanziarie dell'UE, le agenzie decentrate dell'UE (medicinali, sicurezza alimentare, ambiente, sostanze chimiche, droghe, diritti fondamentali e altro), finanziamenti e gare dell'UE, dati aperti e l'intelligence propria di Brubru sull'UE. Gli stessi dati che usiamo internamente sono quelli che chiami. Brubru &egrave; il primo cliente della propria API.",
  "box": "<strong>Una superficie, una chiave.</strong> L'API &egrave; organizzata come l'UE stessa &mdash; una cartella per istituzione od organo, 34 cartelle in totale, <strong>437 endpoint</strong>. Sfoglia le cartelle qui sotto, oppure apri il <a href=\"/api/docs/reference.html\"><strong>riferimento API completo e sempre aggiornato &rarr;</strong></a> &mdash; ogni endpoint distribuito, generato in tempo reale dalla specifica OpenAPI.",
  ...
  "ds_p":"Ogni cartella &egrave; alimentata dalla fonte ufficiale dell'UE e aggiornata automaticamente. La frequenza indicata &egrave; il caso peggiore; le cartelle a passaggio diretto sono in tempo reale.",
  "ds_th":["Livello","Cartelle","Frequenza di aggiornamento"],
  ...
  "next":[
    ("/api/docs/endpoints.html","Tutti gli endpoint","L'elenco completo e raggruppato di tutti i 437 endpoint v2, una sezione per cartella di istituzione."),
...
LANGS["nl"] = {
  ...
  "eyebrow": "Brubru EU Data API &middot; v2 &middot; 437 endpoints in 34 mappen van EU-instellingen",
  "h1": "De EU, gestructureerd.",
  "lede": "Brubru is een verticale EU-dataleverancier. Onze REST-API geeft ontwikkelaars, RegTech-platforms, public-affairsteams en AI-agents programmatische toegang tot <strong>8.710 vastgestelde EU-wetten</strong> (28.513 PB-publicaties), <strong>1.717 lopende wetgevingsprocedures</strong>, <strong>14.873 EU-ambtenaren</strong>, alle Europarlementari&euml;rs, <strong>56.051 amendementen</strong>, de registers van Parlement / Raad / Europese Raad / Eurogroep / Commissie, de Europese Centrale Bank en de financi&euml;le instellingen van de EU, de gedecentraliseerde EU-agentschappen (geneesmiddelen, voedselveiligheid, milieu, chemische stoffen, drugs, grondrechten en meer), EU-financiering en aanbestedingen, open data en Brubru's eigen EU-intelligentie. Dezelfde data die wij intern gebruiken, roept u aan. Brubru is de eerste klant van zijn eigen API.",
  "box": "<strong>E&eacute;n oppervlak, &eacute;&eacute;n sleutel.</strong> De API is ingedeeld zoals de EU zelf &mdash; &eacute;&eacute;n map per instelling of orgaan, 34 mappen in totaal, <strong>437 endpoints</strong>. Blader hieronder door de mappen of open de <a href=\"/api/docs/reference.html\"><strong>volledige, altijd actuele API-referentie &rarr;</strong></a> &mdash; elk uitgerold endpoint, live gegenereerd uit de OpenAPI-specificatie.",
  ...
  "ds_p":"Elke map wordt gevoed door de gezaghebbende EU-bron en automatisch bijgewerkt. De genoemde frequentie is het slechtste geval; live doorgeefmappen zijn realtime.",
  "ds_th":["Laag","Mappen","Verversingsfrequentie"],
  ...
  "next":[
    ("/api/docs/endpoints.html","Alle endpoints","De volledige, gegroepeerde lijst van alle 437 v2-endpoints, &eacute;&eacute;n sectie per instellingsmap."),
...
LANGS["ca"] = {
  ...
  "ds_p":"Cada carpeta s'alimenta de la font oficial de la UE i s'actualitza autom&agrave;ticament. La freq&uuml;&egrave;ncia indicada &eacute;s el pitjor cas; les carpetes de pas en directe s&oacute;n en temps real.",
  "ds_th":["Capa","Carpetes","Freq&uuml;&egrave;ncia d'actualitzaci&oacute;"],
  ...
  "next":[
    ("/api/docs/endpoints.html","Tots els endpoints","La llista completa i agrupada dels 437 endpoints de v2, una secci&oacute; per carpeta d'instituci&oacute;."),
...
COUNT = {"legislative":37,"parliament":38,"council":21,"european-council":12,"eurogroup":10,
 "commission":40,"ecb":17,"eu-financial-institutions":51,"esm":9,"funding":30,"consultations":11,
...
DESC = {
 "legislative":{
  "es":"8.710 leyes adoptadas (28.513 publicaciones del DO) y 1.717 procedimientos en curso, m&aacute;s actos delegados y de ejecuci&oacute;n, texto completo + XML, mapas de considerandos a art&iacute;culos, t&eacute;rminos definidos, EuroVoc, el Tren Legislativo y los resolvedores de citas y alias.",
  "fr":"8 710 actes adopt&eacute;s (28 513 publications du JO) et 1 717 proc&eacute;dures en cours, plus les actes d&eacute;l&eacute;gu&eacute;s et d'ex&eacute;cution, le texte int&eacute;gral + XML, les correspondances consid&eacute;rants-articles, les termes d&eacute;finis, EuroVoc, le Train l&eacute;gislatif et les r&eacute;solveurs de citations et d'alias.",
  "it":"8.710 atti adottati (28.513 pubblicazioni della GU) e 1.717 procedure in corso, pi&ugrave; atti delegati e di esecuzione, testo integrale + XML, mappe considerando-articolo, termini definiti, EuroVoc, il Treno legislativo e i resolver di citazioni e alias.",
  "nl":"8.710 vastgestelde wetten (28.513 PB-publicaties) en 1.717 lopende procedures, plus gedelegeerde en uitvoeringshandelingen, volledige tekst + XML, overweging-naar-artikel-kaarten, gedefinieerde termen, EuroVoc, de Wetgevingstrein en de citatie- en alias-resolvers.",
  "ca":"8.710 lleis adoptades (28.513 publicacions del DO) i 1.717 procediments en curs, m&eacute;s actes delegats i d'execuci&oacute;, text complet + XML, mapes de consideracions a articles, termes definits, EuroVoc, el Tren Legislatiu i els resoluts de cites i &agrave;lies.",
 },
 "parliament":{
...
NAVC = {
 "es":{"starthere":"Empiece aqu&iacute;","intro":"Introducci&oacute;n","fullref":"<strong>Referencia completa de la API</strong> &mdash; los 437 endpoints","auth":"Autenticaci&oacute;n","env":"Sobre de respuesta","err":"Errores","rate":"L&iacute;mites de uso","reference":"Referencia","external":"Externo","institutions":"Instituciones de la UE cubiertas","glossary":"Glosario","usecases":"Casos de uso por perfil","changelog":"Historial de cambios","openapi":"Especificaci&oacute;n OpenAPI (JSON)"},
 "fr":{"starthere":"Commencez ici","intro":"Introduction","fullref":"<strong>R&eacute;f&eacute;rence compl&egrave;te de l'API</strong> &mdash; les 437 endpoints","auth":"Authentification","env":"Enveloppe de r&eacute;ponse","err":"Erreurs","rate":"Limites de d&eacute;bit","reference":"R&eacute;f&eacute;rence","external":"Externe","institutions":"Institutions de l'UE couvertes","glossary":"Glossaire","usecases":"Cas d'usage par profil","changelog":"Journal des modifications","openapi":"Sp&eacute;cification OpenAPI (JSON)"},
 "it":{"starthere":"Inizia qui","intro":"Introduzione","fullref":"<strong>Riferimento API completo</strong> &mdash; tutti i 437 endpoint","auth":"Autenticazione","env":"Busta di risposta","err":"Errori","rate":"Limiti di frequenza","reference":"Riferimento","external":"Esterno","institutions":"Istituzioni dell'UE coperte","glossary":"Glossario","usecases":"Casi d'uso per ruolo","changelog":"Registro modifiche","openapi":"Specifica OpenAPI (JSON)"},
 "nl":{"starthere":"Begin hier","intro":"Inleiding","fullref":"<strong>Volledige API-referentie</strong> &mdash; alle 437 endpoints","auth":"Authenticatie","env":"Response-envelop","err":"Fouten","rate":"Rate-limieten","reference":"Referentie","external":"Extern","institutions":"Gedekte EU-instellingen","glossary":"Woordenlijst","usecases":"Use cases per rol","changelog":"Wijzigingslogboek","openapi":"OpenAPI-specificatie (JSON)"},
 "ca":{"starthere":"Comenceu aqu&iacute;","intro":"Introducci&oacute;","fullref":"<strong>Refer&egrave;ncia completa de l'API</strong> &mdash; els 437 endpoints","auth":"Autenticaci&oacute;","env":"Sobre de resposta","err":"Errors","rate":"L&iacute;mits de crides","reference":"Refer&egrave;ncia","external":"Extern","institutions":"Institucions de la UE cobertes","glossary":"Glossari","usecases":"Casos d'&uacute;s per perfil","changelog":"Hist&ograve;ric de canvis","openapi":"Especificaci&oacute; OpenAPI (JSON)"},
}
...
# Cadence table rows: (layer-label key, folders-html, cadence-text). Folders verbatim.
CAD = {
 "es":[("Legislaci&oacute;n adoptada (EUR-Lex / Cellar de la Oficina de Publicaciones)","<code>legislative</code>","Delta diario del DO &mdash; &lt; 24h tras la publicaci&oacute;n"),
   ("Procedimientos legislativos (OEIL) + Tren Legislativo","<code>legislative</code>","Diario &mdash; &lt; 24h"),
   ("Parlamento (doceo, EP Open Data, multimedia)","<code>parliament</code>","Diario; retransmisiones en vivo"),
   ("Registros del Consejo, Consejo Europeo, Eurogrupo","<code>council</code>, <code>european-council</code>, <code>eurogroup</code>","Diario &mdash; &lt; 24h"),
   ("Comisi&oacute;n (Registro, Transparencia, consultas, RASFF, CORDIS, ayudas estatales, comitolog&iacute;a...)","<code>commission</code>","De en vivo a semanal seg&uacute;n la fuente"),
   ("BCE, instituciones financieras de la UE, MEDE","<code>ecb</code>, <code>eu-financial-institutions</code>, <code>esm</code>","Barrido diario por lotes"),
   ("Agencias descentralizadas de la UE (18 organismos)","<code>acer</code> &hellip; <code>fra</code>","Barrido diario por lotes"),
   ("Financiaci&oacute;n y licitaciones (Portal F&amp;T, TED)","<code>funding</code>, <code>consultations</code>","Diario &mdash; &lt; 24h"),
   ("Datos abiertos, publicaciones, funcionarios","<code>open-data</code>, <code>general-publications</code>, <code>who-is-who</code>","Reingesta semanal masiva"),
   ("Indicaciones geogr&aacute;ficas","<code>geographical-indications</code>","Semanal"),
   ("Propio de Brubru (lobbies, canon, catal&aacute;n, gu&iacute;as)","<code>proprietary</code>","Continuo / al publicar")],
 "fr":[("L&eacute;gislation adopt&eacute;e (EUR-Lex / Cellar de l'Office des publications)","<code>legislative</code>","Delta quotidien du JO &mdash; &lt; 24h apr&egrave;s publication"),
   ("Proc&eacute;dures l&eacute;gislatives (OEIL) + Train l&eacute;gislatif","<code>legislative</code>","Quotidien &mdash; &lt; 24h"),
   ("Parlement (doceo, EP Open Data, multimedia)","<code>parliament</code>","Quotidien ; webstreams en direct"),
   ("Registres du Conseil, Conseil europ&eacute;en, Eurogroupe","<code>council</code>, <code>european-council</code>, <code>eurogroup</code>","Quotidien &mdash; &lt; 24h"),
   ("Commission (Registre, Transparence, consultations, RASFF, CORDIS, aides d'&Eacute;tat, comitologie...)","<code>commission</code>","Du direct &agrave; l'hebdomadaire selon la source"),
   ("BCE, institutions financi&egrave;res de l'UE, MES","<code>ecb</code>, <code>eu-financial-institutions</code>, <code>esm</code>","Balayage quotidien group&eacute;"),
   ("Agences d&eacute;centralis&eacute;es de l'UE (18 organes)","<code>acer</code> &hellip; <code>fra</code>","Balayage quotidien group&eacute;"),
   ("Financements et appels d'offres (portail F&amp;T, TED)","<code>funding</code>, <code>consultations</code>","Quotidien &mdash; &lt; 24h"),
   ("Donn&eacute;es ouvertes, publications, fonctionnaires","<code>open-data</code>, <code>general-publications</code>, <code>who-is-who</code>","R&eacute;-ing&eacute;rement hebdomadaire en masse"),
   ("Indications g&eacute;ographiques","<code>geographical-indications</code>","Hebdomadaire"),
   ("Propri&eacute;taire Brubru (lobbies, canon, catalan, guides)","<code>proprietary</code>","Continu / &agrave; la publication")],
 "it":[("Legislazione adottata (EUR-Lex / Cellar dell'Ufficio delle pubblicazioni)","<code>legislative</code>","Delta giornaliero della GU &mdash; &lt; 24h dalla pubblicazione"),
   ("Procedure legislative (OEIL) + Treno legislativo","<code>legislative</code>","Giornaliero &mdash; &lt; 24h"),
   ("Parlamento (doceo, EP Open Data, multimedia)","<code>parliament</code>","Giornaliero; webstream in diretta"),
   ("Registri di Consiglio, Consiglio europeo, Eurogruppo","<code>council</code>, <code>european-council</code>, <code>eurogroup</code>","Giornaliero &mdash; &lt; 24h"),
   ("Commissione (Registro, Trasparenza, consultazioni, RASFF, CORDIS, aiuti di Stato, comitatologia...)","<code>commission</code>","Da diretta a settimanale secondo la fonte"),
   ("BCE, istituzioni finanziarie dell'UE, MES","<code>ecb</code>, <code>eu-financial-institutions</code>, <code>esm</code>","Scansione giornaliera in batch"),
   ("Agenzie decentrate dell'UE (18 organi)","<code>acer</code> &hellip; <code>fra</code>","Scansione giornaliera in batch"),
   ("Finanziamenti e gare (Portale F&amp;T, TED)","<code>funding</code>, <code>consultations</code>","Giornaliero &mdash; &lt; 24h"),
   ("Dati aperti, pubblicazioni, funzionari","<code>open-data</code>, <code>general-publications</code>, <code>who-is-who</code>","Reingestione settimanale di massa"),
   ("Indicazioni geografiche","<code>geographical-indications</code>","Settimanale"),
   ("Proprietario Brubru (lobby, canon, catalano, guide)","<code>proprietary</code>","Continuo / alla pubblicazione")],
 "nl":[("Vastgestelde wetgeving (EUR-Lex / Cellar van het Publicatiebureau)","<code>legislative</code>","Dagelijkse PB-delta &mdash; &lt; 24u na publicatie"),
   ("Wetgevingsprocedures (OEIL) + Wetgevingstrein","<code>legislative</code>","Dagelijks &mdash; &lt; 24u"),
   ("Parlement (doceo, EP Open Data, multimedia)","<code>parliament</code>","Dagelijks; webstreams live"),
   ("Registers van Raad, Europese Raad, Eurogroep","<code>council</code>, <code>european-council</code>, <code>eurogroup</code>","Dagelijks &mdash; &lt; 24u"),
   ("Commissie (Register, Transparantie, consultaties, RASFF, CORDIS, staatssteun, comitologie...)","<code>commission</code>","Van live tot wekelijks per bron"),
   ("ECB, financi&euml;le instellingen van de EU, ESM","<code>ecb</code>, <code>eu-financial-institutions</code>, <code>esm</code>","Dagelijkse gebundelde sweep"),
   ("Gedecentraliseerde EU-agentschappen (18 organen)","<code>acer</code> &hellip; <code>fra</code>","Dagelijkse gebundelde sweep"),
   ("Financiering en aanbestedingen (F&amp;T-portaal, TED)","<code>funding</code>, <code>consultations</code>","Dagelijks &mdash; &lt; 24u"),
   ("Open data, publicaties, ambtenaren","<code>open-data</code>, <code>general-publications</code>, <code>who-is-who</code>","Wekelijkse bulk-herinname"),
   ("Geografische aanduidingen","<code>geographical-indications</code>","Wekelijks"),
   ("Brubru-eigen (lobby's, canon, Catalaans, gidsen)","<code>proprietary</code>","Doorlopend / bij publicatie")],
 "ca":[("Legislaci&oacute; adoptada (EUR-Lex / Cellar de l'Oficina de Publicacions)","<code>legislative</code>","Delta diari del DO &mdash; &lt; 24h despr&eacute;s de la publicaci&oacute;"),
   ("Procediments legislatius (OEIL) + Tren Legislatiu","<code>legislative</code>","Diari &mdash; &lt; 24h"),
   ("Parlament (doceo, EP Open Data, multim&egrave;dia)","<code>parliament</code>","Diari; retransmissions en directe"),
   ("Registres del Consell, Consell Europeu, Eurogrup","<code>council</code>, <code>european-council</code>, <code>eurogroup</code>","Diari &mdash; &lt; 24h"),
   ("Comissi&oacute; (Registre, Transpar&egrave;ncia, consultes, RASFF, CORDIS, ajuts estatals, comitologia...)","<code>commission</code>","De directe a setmanal seg&oacute;ns la font"),
   ("BCE, institucions financeres de la UE, MEDE","<code>ecb</code>, <code>eu-financial-institutions</code>, <code>esm</code>","Escombrat diari per lots"),
   ("Ag&egrave;ncies descentralitzades de la UE (18 organismes)","<code>acer</code> &hellip; <code>fra</code>","Escombrat diari per lots"),
   ("Finan&ccedil;ament i licitacions (Portal F&amp;T, TED)","<code>funding</code>, <code>consultations</code>","Diari &mdash; &lt; 24h"),
   ("Dades obertes, publicacions, funcionaris","<code>open-data</code>, <code>general-publications</code>, <code>who-is-who</code>","Reingesti&oacute; setmanal massiva"),
   ("Indicacions geogr&agrave;fiques","<code>geographical-indications</code>","Setmanal"),
   ("Propi de Brubru (lobbies, canon, catal&agrave;, guies)","<code>proprietary</code>","Continu / en publicar")],
}

def build_cadence(lang):
    L=LANGS[lang]; th=L["ds_th"]
    out=['<table>', f'<thead><tr><th>{th[0]}</th><th>{th[1]}</th><th>{th[2]}</th></tr></thead>','<tbody>']
    for layer,folders,cad in CAD[lang]:
        out.append(f'<tr><td>{layer}</td><td>{folders}</td><td>{cad}</td></tr>')
    out += ['</tbody>','</table>']
    return '\n'.join(out)
