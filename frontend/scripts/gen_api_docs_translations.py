...
LANGS["es"] = {
  ...
  "desc": "Brubru EU Data API v2: 477 endpoints REST en 34 carpetas de instituciones de la UE. 8.710 leyes de la UE, procedimientos legislativos, eurodiputados y funcionarios, enmiendas, las bases de datos de Parlamento / Consejo / Comisi&oacute;n, las bases de datos de las agencias de la UE (medicamentos, seguridad alimentaria, medio ambiente, sustancias qu&iacute;micas, drogas, derechos fundamentales), financiaci&oacute;n, datos abiertos y la inteligencia propia de Brubru sobre la UE. Una sola clave de API.",
  ...
  "eyebrow": "Brubru EU Data API &middot; v2 &middot; 477 endpoints en 34 carpetas de instituciones de la UE",
  ...
  "box": "<strong>Una superficie, una clave.</strong> La API est&aacute; organizada como la propia UE &mdash; una carpeta por instituci&oacute;n u organismo, 34 carpetas en total, <strong>477 endpoints</strong>. Explore las carpetas a continuaci&oacute;n o abra la <a href=\"/api/docs/reference.html\"><strong>referencia completa y siempre actualizada de la API &rarr;</strong></a> &mdash; cada endpoint desplegado, generado en vivo desde la especificaci&oacute;n OpenAPI.",
  ...
  "next":[
    ("/api/docs/endpoints.html","Todos los endpoints","La lista completa y agrupada de los 477 endpoints de v2, una secci&oacute;n por carpeta de instituci&oacute;n."),
...
LANGS["fr"] = {
  ...
  "desc": "Brubru EU Data API v2 : 477 endpoints REST r&eacute;partis sur 34 dossiers d'institutions de l'UE. 8 710 actes de l'UE, proc&eacute;dures l&eacute;gislatives, d&eacute;put&eacute;s et fonctionnaires, amendements, les bases de donn&eacute;es du Parlement / Conseil / Commission, les bases des agences de l'UE (m&eacute;dicaments, s&eacute;curit&eacute; alimentaire, environnement, produits chimiques, drogues, droits fondamentaux), financements, donn&eacute;es ouvertes et l'intelligence propre de Brubru sur l'UE. Une seule cl&eacute; d'API.",
  ...
  "eyebrow": "Brubru EU Data API &middot; v2 &middot; 477 endpoints sur 34 dossiers d'institutions de l'UE",
  ...
  "next":[
    ("/api/docs/endpoints.html","Tous les endpoints","La liste compl&egrave;te et regroup&eacute;e des 477 endpoints v2, une section par dossier d'institution."),
...
LANGS["it"] = {
  ...
  "desc": "Brubru EU Data API v2: 477 endpoint REST in 34 cartelle di istituzioni dell'UE. 8.710 atti dell'UE, procedure legislative, deputati e funzionari, emendamenti, le banche dati di Parlamento / Consiglio / Commissione, le banche dati delle agenzie dell'UE (medicinali, sicurezza alimentare, ambiente, sostanze chimiche, droghe, diritti fondamentali), finanziamenti, dati aperti e l'intelligence propria di Brubru sull'UE. Una sola chiave API.",
  ...
  "eyebrow": "Brubru EU Data API &middot; v2 &middot; 477 endpoint in 34 cartelle di istituzioni dell'UE",
  "h1": "L'UE, strutturata.",
  ...
  "box": "<strong>Una superficie, una chiave.</strong> L'API &egrave; organizzata come l'UE stessa &mdash; una cartella per istituzione od organo, 34 cartelle in totale, <strong>477 endpoint</strong>. Sfoglia le cartelle qui sotto, oppure apri il <a href=\"/api/docs/reference.html\"><strong>riferimento API completo e sempre aggiornato &rarr;</strong></a> &mdash; ogni endpoint distribuito, generato in tempo reale dalla specifica OpenAPI.",
  ...
  "next":[
    ("/api/docs/endpoints.html","Tutti gli endpoint","L'elenco completo e raggruppato di tutti i 477 endpoint v2, una sezione per cartella di istituzione."),
...
LANGS["nl"] = {
  ...
  "eyebrow": "Brubru EU Data API &middot; v2 &middot; 477 endpoints in 34 mappen van EU-instellingen",
  ...
  "box": "<strong>E&eacute;n oppervlak, &eacute;&eacute;n sleutel.</strong> De API is ingedeeld zoals de EU zelf &mdash; &eacute;&eacute;n map per instelling of orgaan, 34 mappen in totaal, <strong>477 endpoints</strong>. Blader hieronder door de mappen of open de <a href=\"/api/docs/reference.html\"><strong>volledige, altijd actuele API-referentie &rarr;</strong></a> &mdash; elk uitgerold endpoint, live gegenereerd uit de OpenAPI-specificatie.",
  ...
  "next":[
    ("/api/docs/endpoints.html","Alle endpoints","De volledige, gegroepeerde lijst van alle 477 v2-endpoints, &eacute;&eacute;n sectie per instellingsmap."),
...
LANGS["ca"] = {
  ...
  "eyebrow": "Brubru EU Data API &middot; v2 &middot; 477 endpoints en 34 carpetes d'institucions de la UE",
  "h1": "La UE, estructurada.",
  ...
  "box": "<strong>Una superf&iacute;cie, una clau.</strong> L'API est&agrave; organitzada com la mateixa UE &mdash; una carpeta per instituci&oacute; o organisme, 34 carpetes en total, <strong>477 endpoints</strong>. Exploreu les carpetes a continuaci&oacute;, o obriu la <a href=\"/api/docs/reference.html\"><strong>refer&egrave;ncia completa i sempre actualitzada de l'API &rarr;</strong></a> &mdash; cada endpoint desplegat, generat en directe des de l'especificaci&oacute; OpenAPI.",
  ...
  "next":[
    ("/api/docs/endpoints.html","Tots els endpoints","La llista completa i agrupada dels 477 endpoints de v2, una secci&oacute; per carpeta d'instituci&oacute;."),
...
COUNT = {"legislative":37,"parliament":38,"council":21,"european-council":12,"eurogroup":10,
 "commission":40,"ecb":17,"eu-financial-institutions":51,"esm":9,"funding":70,"consultations":11,
...
NAVC = {
 "es":{"starthere":"Empiece aqu&iacute;","intro":"Introducci&oacute;n","fullref":"<strong>Referencia completa de la API</strong> &mdash; los 477 endpoints","auth":"Autenticaci&oacute;n","env":"Sobre de respuesta","err":"Errores","rate":"L&iacute;mites de uso","reference":"Referencia","external":"Externo","institutions":"Instituciones de la UE cubiertas","glossary":"Glosario","usecases":"Casos de uso por perfil","changelog":"Historial de cambios","openapi":"Especificaci&oacute;n OpenAPI (JSON)"},
 "fr":{"starthere":"Commencez ici","intro":"Introduction","fullref":"<strong>R&eacute;f&eacute;rence compl&egrave;te de l'API</strong> &mdash; les 477 endpoints","auth":"Authentification","env":"Enveloppe de r&eacute;ponse","err":"Erreurs","rate":"Limites de d&eacute;bit","reference":"R&eacute;f&eacute;rence","external":"Externe","institutions":"Institutions de l'UE couvertes","glossary":"Glossaire","usecases":"Cas d'usage par profil","changelog":"Journal des modifications","openapi":"Sp&eacute;cification OpenAPI (JSON)"},
 "it":{"starthere":"Inizia qui","intro":"Introduzione","fullref":"<strong>Riferimento API completo</strong> &mdash; tutti i 477 endpoint","auth":"Autenticazione","env":"Busta di risposta","err":"Errori","rate":"Limiti di frequenza","reference":"Riferimento","external":"Esterno","institutions":"Istituzioni dell'UE coperte","glossary":"Glossario","usecases":"Casi d'uso per ruolo","changelog":"Registro modifiche","openapi":"Specifica OpenAPI (JSON)"},
 "nl":{"starthere":"Begin hier","intro":"Inleiding","fullref":"<strong>Volledige API-referentie</strong> &mdash; alle 477 endpoints","auth":"Authenticatie","env":"Response-envelop","err":"Fouten","rate":"Rate-limieten","reference":"Referentie","external":"Extern","institutions":"Gedekte EU-instellingen","glossary":"Woordenlijst","usecases":"Use cases per rol","changelog":"Wijzigingslogboek","openapi":"OpenAPI-specificatie (JSON)"},
 "ca":{"starthere":"Comenceu aqu&iacute;","intro":"Introducci&oacute;","fullref":"<strong>Refer&egrave;ncia completa de l'API</strong> &mdash; els 477 endpoints","auth":"Autenticaci&oacute;","env":"Sobre de resposta","err":"Errors","rate":"L&iacute;mits de crides","reference":"Refer&egrave;ncia","external":"Extern","institutions":"Institucions de la UE cobertes","glossary":"Glossari","usecases":"Casos d'&uacute;s per perfil","changelog":"Hist&ograve;ric de canvis","openapi":"Especificaci&oacute; OpenAPI (JSON)"},
}
