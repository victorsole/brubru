...
const ROUTE_META = {
  ...
  '/eucanon/2011-1007_textile_labelling/': { priority: 0.9, changefreq: 'monthly' },
  ...
  '/eucanon/2001-83_community_code/':         { priority: 0.9, changefreq: 'monthly' },
  '/eucanon/2004-24_herbal/':                 { priority: 0.9, changefreq: 'monthly' },
  '/eucanon/2010-84_pharmacovigilance/':      { priority: 0.9, changefreq: 'monthly' },
  '/eucanon/2011-62_falsified_medicines/':    { priority: 0.9, changefreq: 'monthly' },
  '/eucanon/2012-26_pv_amend/':               { priority: 0.9, changefreq: 'monthly' },
  '/eucanon/2018-1972_eecc/':            { priority: 0.9, changefreq: 'monthly' },
  '/eucanon/2009-138_solvency2/':        { priority: 0.9, changefreq: 'monthly' },
  '/eucanon/2014-65_mifid2/':            { priority: 0.9, changefreq: 'monthly' },
  '/eucanon/2018-859_amazon_state_aid/':     { priority: 0.9, changefreq: 'monthly' },
  '/eucanon/2017-1283_apple_state_aid/':     { priority: 0.9, changefreq: 'monthly' },
  '/eucanon/2023-1683_la_rochelle_airport/': { priority: 0.9, changefreq: 'monthly' },
  '/eucanon/2016-633_nimes_airport/':        { priority: 0.9, changefreq: 'monthly' },
  '/eucanon/2025-1963_cineca/':              { priority: 0.9, changefreq: 'monthly' },
  '/eucanon/2020-1412_tirrenia/':            { priority: 0.9, changefreq: 'monthly' },
  '/eucanon/2016-679_gdpr/':                 { priority: 0.9, changefreq: 'monthly' },
